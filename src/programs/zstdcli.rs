...
extern "C" {
    ...
    fn FIO_setUseRowMatchFinder(
        prefs: *mut FIO_prefs_t,
        useRowMatchFinder: std::ffi::c_int,
    );
    ...
    fn FIO_setLdmBucketSizeLog(
        prefs: *mut FIO_prefs_t,
        ldmBucketSizeLog: std::ffi::c_int,
    );
    ...
    fn FIO_setAllowBlockDevices(
        prefs: *mut FIO_prefs_t,
        allowBlockDevices: std::ffi::c_int,
    );
...
pub type zstd_operation_mode = std::ffi::c_uint;
...
pub const ZSTD_TARGETLENGTH_MAX: std::ffi::c_int = (1 as std::ffi::c_int)
    << ZSTD_BLOCKSIZELOG_MAX;
...
pub const stdinmark: [std::ffi::c_char; 10] = unsafe {
    *::core::mem::transmute::<&[u8; 10], &[std::ffi::c_char; 10]>(b"/*stdin*\\\0")
};
pub const stdoutmark: [std::ffi::c_char; 11] = unsafe {
    *::core::mem::transmute::<&[u8; 11], &[std::ffi::c_char; 11]>(b"/*stdout*\\\0")
};
pub const nulmark: [std::ffi::c_char; 10] = unsafe {
    *::core::mem::transmute::<&[u8; 10], &[std::ffi::c_char; 10]>(b"/dev/null\0")
};
pub const LZMA_EXTENSION: [std::ffi::c_char; 6] = unsafe {
    *::core::mem::transmute::<&[u8; 6], &[std::ffi::c_char; 6]>(b".lzma\0")
};
pub const XZ_EXTENSION: [std::ffi::c_char; 4] = unsafe {
    *::core::mem::transmute::<&[u8; 4], &[std::ffi::c_char; 4]>(b".xz\0")
};
pub const GZ_EXTENSION: [std::ffi::c_char; 4] = unsafe {
    *::core::mem::transmute::<&[u8; 4], &[std::ffi::c_char; 4]>(b".gz\0")
};
pub const ZSTD_EXTENSION: [std::ffi::c_char; 5] = unsafe {
    *::core::mem::transmute::<&[u8; 5], &[std::ffi::c_char; 5]>(b".zst\0")
};
pub const LZ4_EXTENSION: [std::ffi::c_char; 5] = unsafe {
    *::core::mem::transmute::<&[u8; 5], &[std::ffi::c_char; 5]>(b".lz4\0")
};
...
pub const ZSTD_ZSTDMT: [std::ffi::c_char; 7] = unsafe {
    *::core::mem::transmute::<&[u8; 7], &[std::ffi::c_char; 7]>(b"zstdmt\0")
};
pub const ZSTD_UNZSTD: [std::ffi::c_char; 7] = unsafe {
    *::core::mem::transmute::<&[u8; 7], &[std::ffi::c_char; 7]>(b"unzstd\0")
};
pub const ZSTD_CAT: [std::ffi::c_char; 8] = unsafe {
    *::core::mem::transmute::<&[u8; 8], &[std::ffi::c_char; 8]>(b"zstdcat\0")
};
pub const ZSTD_ZCAT: [std::ffi::c_char; 5] = unsafe {
    *::core::mem::transmute::<&[u8; 5], &[std::ffi::c_char; 5]>(b"zcat\0")
};
pub const ZSTD_GZ: [std::ffi::c_char; 5] = unsafe {
    *::core::mem::transmute::<&[u8; 5], &[std::ffi::c_char; 5]>(b"gzip\0")
};
pub const ZSTD_GUNZIP: [std::ffi::c_char; 7] = unsafe {
    *::core::mem::transmute::<&[u8; 7], &[std::ffi::c_char; 7]>(b"gunzip\0")
};
pub const ZSTD_GZCAT: [std::ffi::c_char; 6] = unsafe {
    *::core::mem::transmute::<&[u8; 6], &[std::ffi::c_char; 6]>(b"gzcat\0")
};
pub const ZSTD_LZMA: [std::ffi::c_char; 5] = unsafe {
    *::core::mem::transmute::<&[u8; 5], &[std::ffi::c_char; 5]>(b"lzma\0")
};
pub const ZSTD_UNLZMA: [std::ffi::c_char; 7] = unsafe {
    *::core::mem::transmute::<&[u8; 7], &[std::ffi::c_char; 7]>(b"unlzma\0")
};
pub const ZSTD_XZ: [std::ffi::c_char; 3] = unsafe {
    *::core::mem::transmute::<&[u8; 3], &[std::ffi::c_char; 3]>(b"xz\0")
};
pub const ZSTD_UNXZ: [std::ffi::c_char; 5] = unsafe {
    *::core::mem::transmute::<&[u8; 5], &[std::ffi::c_char; 5]>(b"unxz\0")
};
pub const ZSTD_LZ4: [std::ffi::c_char; 4] = unsafe {
    *::core::mem::transmute::<&[u8; 4], &[std::ffi::c_char; 4]>(b"lz4\0")
};
pub const ZSTD_UNLZ4: [std::ffi::c_char; 6] = unsafe {
    *::core::mem::transmute::<&[u8; 6], &[std::ffi::c_char; 6]>(b"unlz4\0")
};
pub const DISPLAY_LEVEL_DEFAULT: std::ffi::c_int = 2 as std::ffi::c_int;
static mut g_defaultDictName: *const std::ffi::c_char = b"dictionary\0" as *const u8
    as *const std::ffi::c_char;
static mut g_defaultMaxDictSize: std::ffi::c_uint = (110 as std::ffi::c_int
    * ((1 as std::ffi::c_int) << 10 as std::ffi::c_int)) as std::ffi::c_uint;
static mut g_defaultDictCLevel: std::ffi::c_int = 3 as std::ffi::c_int;
static mut g_defaultSelectivityLevel: std::ffi::c_uint = 9 as std::ffi::c_int
    as std::ffi::c_uint;
static mut g_defaultMaxWindowLog: std::ffi::c_uint = 27 as std::ffi::c_int
    as std::ffi::c_uint;
...
unsafe extern "C" fn checkLibVersion() {
    if strcmp(b"1.5.8\0" as *const u8 as *const std::ffi::c_char, ZSTD_versionString())
        != 0
    {
...
unsafe extern "C" fn usageAdvanced(mut programName: *const std::ffi::c_char) {
    fprintf(
        stdout,
        b"*** %s (%i-bit) %s, by %s ***\n\0" as *const u8 as *const std::ffi::c_char,
    ...
    let mut passThroughDefault = b"Disabled\0" as *const u8 as *const std::ffi::c_char;
    ...
    {
        passThroughDefault = b"Enabled\0" as *const u8 as *const std::ffi::c_char;
    }
    fprintf(
        stdout,
...
unsafe extern "C" fn waitEnter() {
    let mut unused: std::ffi::c_int = 0;
    fprintf(
        stderr,
...
unsafe extern "C" fn readU32FromCharChecked(
    ...
    {
        let max = (-(1 as std::ffi::c_int) as std::ffi::c_uint)
        ...
        result = result
            .wrapping_add(
                (**stringPtr as std::ffi::c_int - '0' as i32) as std::ffi::c_uint,
            );
        if result < last {
            return 1 as std::ffi::c_int;
        }
    ...
    if **stringPtr as std::ffi::c_int == 'K' as i32
        || **stringPtr as std::ffi::c_int == 'M' as i32
    {
...
unsafe extern "C" fn readU32FromChar(
    ...
    static mut errorMsg: [std::ffi::c_char; 51] = unsafe {
        *::core::mem::transmute::<
            &[u8; 51],
            &[std::ffi::c_char; 51],
...
unsafe extern "C" fn readIntFromChar(
    ...
    static mut errorMsg: [std::ffi::c_char; 42] = unsafe {
        *::core::mem::transmute::<
            &[u8; 42],
            &[std::ffi::c_char; 42],
...
unsafe extern "C" fn readSizeTFromCharChecked(
        ...
        && **stringPtr as std::ffi::c_int <= '9' as i32
    {
        ...
        result = result
            .wrapping_add((**stringPtr as std::ffi::c_int - '0' as i32) as size_t);
        if result < last {
            return 1 as std::ffi::c_int;
        }
        *stringPtr = (*stringPtr).offset(1);
...
unsafe extern "C" fn longCommandWArg(
    mut stringPtr: *mut *const std::ffi::c_char,
    mut longCommand: *const std::ffi::c_char,
) -> std::ffi::c_int {
    let comSize = strlen(longCommand);
    let result = (strncmp(*stringPtr, longCommand, comSize) == 0) as std::ffi::c_int;
    if result != 0 {
...
unsafe extern "C" fn parseAdaptParameters(
    ...
    mut adaptMinPtr: *mut std::ffi::c_int,
    mut adaptMaxPtr: *mut std::ffi::c_int,
) -> std::ffi::c_uint {
    loop {
        if longCommandWArg(
            &mut stringPtr,
        ...
        ) != 0
        {
            *adaptMinPtr = readIntFromChar(&mut stringPtr);
            if !(*stringPtr.offset(0 as std::ffi::c_int as isize) as std::ffi::c_int
                == ',' as i32)
            {
                break;
            }
...
unsafe extern "C" fn parseCompressionParameters(
    ...
    loop {
        if longCommandWArg(
            &mut stringPtr,
            b"windowLog=\0" as *const u8 as *const std::ffi::c_char,
        ) != 0
            || longCommandWArg(
                &mut stringPtr,
                b"wlog=\0" as *const u8 as *const std::ffi::c_char,
            ) != 0
        {
            ...
            || longCommandWArg(
                &mut stringPtr,
                b"clog=\0" as *const u8 as *const std::ffi::c_char,
            ) != 0
        {
            ...
            || longCommandWArg(
                &mut stringPtr,
                b"hlog=\0" as *const u8 as *const std::ffi::c_char,
            ) != 0
        {
            ...
            || longCommandWArg(
                &mut stringPtr,
                b"slog=\0" as *const u8 as *const std::ffi::c_char,
            ) != 0
        {
            ...
            || longCommandWArg(
                &mut stringPtr,
                b"mml=\0" as *const u8 as *const std::ffi::c_char,
            ) != 0
        {
            ...
            || longCommandWArg(
                &mut stringPtr,
                b"tlen=\0" as *const u8 as *const std::ffi::c_char,
            ) != 0
        {
            ...
            || longCommandWArg(
                &mut stringPtr,
                b"strat=\0" as *const u8 as *const std::ffi::c_char,
            ) != 0
        {
            ...
            || longCommandWArg(
                &mut stringPtr,
                b"ovlog=\0" as *const u8 as *const std::ffi::c_char,
            ) != 0
        {
            ...
            || longCommandWArg(
                &mut stringPtr,
                b"lhlog=\0" as *const u8 as *const std::ffi::c_char,
            ) != 0
        {
            ...
            || longCommandWArg(
                &mut stringPtr,
                b"lmml=\0" as *const u8 as *const std::ffi::c_char,
            ) != 0
        {
            ...
            || longCommandWArg(
                &mut stringPtr,
                b"lblog=\0" as *const u8 as *const std::ffi::c_char,
            ) != 0
        {
            ...
            || longCommandWArg(
                &mut stringPtr,
                b"lhrlog=\0" as *const u8 as *const std::ffi::c_char,
            ) != 0
        {
...
unsafe extern "C" fn setMaxCompression(mut params: *mut ZSTD_compressionParameters) {
    (*params)
        .windowLog = (if ::core::mem::size_of::<size_t>() as std::ffi::c_ulong
    ...
    (*params)
        .chainLog = (if ::core::mem::size_of::<size_t>() as std::ffi::c_ulong
        == 4 as std::ffi::c_int as std::ffi::c_ulong
    {
    ...
    (*params)
        .hashLog = (if (if ::core::mem::size_of::<size_t>() as std::ffi::c_ulong
        == 4 as std::ffi::c_int as std::ffi::c_ulong
    {
        ZSTD_WINDOWLOG_MAX_32
    } else {
    ...
    (*params)
        .searchLog = ((if ::core::mem::size_of::<size_t>() as std::ffi::c_ulong
        == 4 as std::ffi::c_int as std::ffi::c_ulong
    {
        ZSTD_WINDOWLOG_MAX_32
    } else {
...
unsafe extern "C" fn printVersion() {
    ...
    if g_displayLevel >= 3 as std::ffi::c_int {
        fprintf(stdout, b"*** supports: zstd\0" as *const u8 as *const std::ffi::c_char);
        fprintf(
            stdout,
...
static mut ZSTD_strategyMap: [*const std::ffi::c_char; 10] = [
    b"\0" as *const u8 as *const std::ffi::c_char,
    b"ZSTD_fast\0" as *const u8 as *const std::ffi::c_char,
    b"ZSTD_dfast\0" as *const u8 as *const std::ffi::c_char,
    b"ZSTD_greedy\0" as *const u8 as *const std::ffi::c_char,
    b"ZSTD_lazy\0" as *const u8 as *const std::ffi::c_char,
    b"ZSTD_lazy2\0" as *const u8 as *const std::ffi::c_char,
    b"ZSTD_btlazy2\0" as *const u8 as *const std::ffi::c_char,
    b"ZSTD_btopt\0" as *const u8 as *const std::ffi::c_char,
    b"ZSTD_btultra\0" as *const u8 as *const std::ffi::c_char,
    b"ZSTD_btultra2\0" as *const u8 as *const std::ffi::c_char,
];
unsafe extern "C" fn printDefaultCParams(
    ...
    let mut fileSize = UTIL_getFileSize(filename) as std::ffi::c_ulonglong;
    ...
    fprintf(
        stderr,
        b" - strategy      : %s (%u)\n\0" as *const u8 as *const std::ffi::c_char,
        ZSTD_strategyMap[cParams.strategy as std::ffi::c_int as usize],
...
unsafe extern "C" fn printActualCParams(
    ...
    if g_displayLevel >= 4 as std::ffi::c_int {} else {
        __assert_fail(
    ...
    actualCParams
        .windowLog = if (*cParams).windowLog == 0 as std::ffi::c_int as std::ffi::c_uint
    {
    ...
    actualCParams
        .chainLog = if (*cParams).chainLog == 0 as std::ffi::c_int as std::ffi::c_uint {
        actualCParams.chainLog
    } else {
        (*cParams).chainLog
    };
    actualCParams
        .hashLog = if (*cParams).hashLog == 0 as std::ffi::c_int as std::ffi::c_uint {
        actualCParams.hashLog
    } else {
        (*cParams).hashLog
    };
    actualCParams
        .searchLog = if (*cParams).searchLog == 0 as std::ffi::c_int as std::ffi::c_uint
    {
    ...
    actualCParams
        .minMatch = if (*cParams).minMatch == 0 as std::ffi::c_int as std::ffi::c_uint {
        actualCParams.minMatch
    } else {
        (*cParams).minMatch
    };
    actualCParams
        .targetLength = if (*cParams).targetLength
    ...
    actualCParams
        .strategy = (if (*cParams).strategy as std::ffi::c_uint
        == 0 as std::ffi::c_int as std::ffi::c_uint
    {
...
pub const ENV_CLEVEL: [std::ffi::c_char; 12] = unsafe {
    *::core::mem::transmute::<&[u8; 12], &[std::ffi::c_char; 12]>(b"ZSTD_CLEVEL\0")
};
pub const ENV_NBWORKERS: [std::ffi::c_char; 15] = unsafe {
    *::core::mem::transmute::<&[u8; 15], &[std::ffi::c_char; 15]>(b"ZSTD_NBTHREADS\0")
};
unsafe extern "C" fn init_cLevel() -> std::ffi::c_int {
                ...
                if g_displayLevel >= 2 as std::ffi::c_int {
                    fprintf(
                        ...
                        b"Ignore environment variable setting %s=%s: numeric value too large \n\0"
                            as *const u8 as *const std::ffi::c_char,
                        b"ZSTD_CLEVEL\0" as *const u8 as *const std::ffi::c_char,
                        env,
                    );
                }
            ...
            if readU32FromCharChecked(&mut ptr, &mut nbThreads) != 0 {
                if g_displayLevel >= 2 as std::ffi::c_int {
                    fprintf(
                        ...
                        b"Ignore environment variable setting %s=%s: numeric value too large \n\0"
                            as *const u8 as *const std::ffi::c_char,
                        b"ZSTD_NBTHREADS\0" as *const u8 as *const std::ffi::c_char,
                        env,
                    );
                }
                return (if 1 as std::ffi::c_int
                    > (if (4 as std::ffi::c_int)
...
unsafe fn main_0(
    ...
    let mut dictFileName = NULL as *const std::ffi::c_char;
    ...
    checkLibVersion();
    if argCount >= 1 as std::ffi::c_int {} else {
        __assert_fail(
    ...
    memset(
        &mut compressionParams as *mut ZSTD_compressionParameters
    ...
    's_365: loop {
        if !(argNb < argCount) {
            current_block = 18130140545993639027;
            break;
        }
        ...
        if !argument.is_null() {
            ...
            } else if strcmp(argument, b"-\0" as *const u8 as *const std::ffi::c_char)
                == 0
            {
                ...
                == '-' as i32
            {
                if *argument.offset(1 as std::ffi::c_int as isize) as std::ffi::c_int
                    == '-' as i32
                {
                    if strcmp(argument, b"--\0" as *const u8 as *const std::ffi::c_char)
                        == 0
                    {
                    ...
                    ) == 0
                    {
                        ...
                        argument,
                        b"--uncompress\0" as *const u8 as *const std::ffi::c_char,
                    ) == 0
                    {
                        operation = zom_decompress;
                    } else if strcmp(
                        argument,
                        b"--force\0" as *const u8 as *const std::ffi::c_char,
                    ) == 0
                    {
                        FIO_overwriteMode(prefs);
                    ...
                    ) == 0
                    {
                        ...
                        current_block = 6144696472884232842;
                        break;
                    } else if strcmp(
                        argument,
                        b"--help\0" as *const u8 as *const std::ffi::c_char,
                    ) == 0
                    {
                        ...
                        argument,
                        b"--verbose\0" as *const u8 as *const std::ffi::c_char,
                    ) == 0
                    {
                        g_displayLevel += 1;
                        g_displayLevel;
                    ...
                    ) == 0
                    {
                        ...
                        argument,
                        b"--rm\0" as *const u8 as *const std::ffi::c_char,
                    ) == 0
                    {
                        removeSrcFile = 1 as std::ffi::c_int;
                    } else if strcmp(
                    ...
                    ) == 0
                    {
                        ...
                        argument,
                        b"--show-default-cparams\0" as *const u8
                            as *const std::ffi::c_char,
                    ) == 0
                    {
                    ...
                    ) == 0
                    {
                        ...
                        argument,
                        b"--no-row-match-finder\0" as *const u8
                            as *const std::ffi::c_char,
                    ) == 0
                    {
                    ...
                    ) == 0
                    {
                        ...
                        argument,
                        b"--mmap-dict\0" as *const u8 as *const std::ffi::c_char,
                    ) == 0
                    {
                        mmapDict = ZSTD_ps_enable;
                    } else if strcmp(
                        argument,
                        b"--no-mmap-dict\0" as *const u8 as *const std::ffi::c_char,
                    ) == 0
                    {
                    ...
                    ) == 0
                    {
                        ...
                        argument,
                        b"--no-progress\0" as *const u8 as *const std::ffi::c_char,
                    ) == 0
                    {
                        progress = FIO_ps_never;
                    } else if strcmp(
                        argument,
                        b"--progress\0" as *const u8 as *const std::ffi::c_char,
                    ) == 0
                    {
                    ...
                    ) == 0
                    {
                        ...
                        argument,
                        b"--trace-file-stat\0" as *const u8 as *const std::ffi::c_char,
                    ) == 0
                    {
                        UTIL_traceFileStat();
                    } else if strcmp(
                        ...
                        if *argument as std::ffi::c_int == '=' as i32 {
                            ...
                            if argNb >= argCount {
                                ...
                                if !__nb.is_null() {} else {
                                    __assert_fail(
                                        b"__nb != NULL\0" as *const u8 as *const std::ffi::c_char,
                    ...
                    ) != 0
                    {
                        ...
                        &mut argument,
                        b"--zstd=\0" as *const u8 as *const std::ffi::c_char,
                    ) != 0
                    {
                    ...
                    ) != 0
                    {
                        ...
                        &mut argument,
                        b"--output-dir-flat\0" as *const u8 as *const std::ffi::c_char,
                    ) != 0
                    {
                        if *argument as std::ffi::c_int == '=' as i32 {
                            argument = argument.offset(1);
                        ...
                        &mut argument,
                        b"--auto-threads\0" as *const u8 as *const std::ffi::c_char,
                    ) != 0
                    {
                        let mut threadDefault = NULL as *const std::ffi::c_char;
                        if *argument as std::ffi::c_int == '=' as i32 {
                            argument = argument.offset(1);
                        ...
                        &mut argument,
                        b"--output-dir-mirror\0" as *const u8 as *const std::ffi::c_char,
                    ) != 0
                    {
                        if *argument as std::ffi::c_int == '=' as i32 {
                            argument = argument.offset(1);
                            ...
                            if argNb >= argCount {
                                ...
                                if *outMirroredDirName.offset(0 as std::ffi::c_int as isize)
                                    as std::ffi::c_int == '-' as i32
                                {
                                    if g_displayLevel >= 1 as std::ffi::c_int {
                                        fprintf(
                        ...
                        &mut argument,
                        b"--patch-from\0" as *const u8 as *const std::ffi::c_char,
                    ) != 0
                    {
                        if *argument as std::ffi::c_int == '=' as i32 {
                            argument = argument.offset(1);
                    ...
                    ) != 0
                    {
                        ...
                        &mut argument,
                        b"--fast\0" as *const u8 as *const std::ffi::c_char,
                    ) != 0
                    {
                        if *argument as std::ffi::c_int == '=' as i32 {
                            ...
                            if fastLevel != 0 {
                                cLevel = -(fastLevel as std::ffi::c_int);
                                dictCLevel = cLevel;
                            } else {
                                badUsage(programName, originalArgument);
                                operationResult = 1 as std::ffi::c_int;
                    ...
                    argument = argument.offset(1);
                    argument;
                    while *argument.offset(0 as std::ffi::c_int as isize)
                        as std::ffi::c_int != 0 as std::ffi::c_int
                    {
                            ...
                            && *argument as std::ffi::c_int <= '9' as i32
                        {
                            ...
                            match *argument.offset(0 as std::ffi::c_int as isize)
                                as std::ffi::c_int
                            {
                                86 => {
                                    printVersion();
                                ...
                                _ => {
                                    ...
                                    shortArgument[1 as std::ffi::c_int
                                        as usize] = *argument.offset(0 as std::ffi::c_int as isize);
    ...
    match current_block {
        18130140545993639027 => {
            ...
            if operation as std::ffi::c_uint
                == zom_compress as std::ffi::c_int as std::ffi::c_uint
            {
                if g_displayLevel >= 4 as std::ffi::c_int {
                    fprintf(
                        stderr,
            ...
            if followLinks == 0 {
                    ...
                    && nbFilenames > 0 as std::ffi::c_int as std::ffi::c_uint
                {
                    ...
                    current_block = 1345513189434928622;
                }
            } else {
                current_block = 1345513189434928622;
            }
            match current_block {
                ...
                _ => {
                    if (*file_of_names).tableSize != 0 {
                        ...
                        loop {
                            if !(flNb < nbFileLists) {
                                current_block = 3556305802176642583;
                                break;
                            }
                                    ...
                                    == zom_train as std::ffi::c_int as std::ffi::c_uint
                                {
                                    ...
                                    if (*filenames).tableSize == 0 as std::ffi::c_int as size_t
                                    {
                                        if nbInputFileNames > 0 as std::ffi::c_int as size_t {
                                            ...
                                            UTIL_refFilename(filenames, stdinmark.as_ptr());
                                            current_block = 6109273980376460047;
                                        }
                                    } else {
                                        current_block = 6109273980376460047;
                                    }
                                        ...
                                        _ => {
                                            ...
                                            if forceStdin == 0
                                                && UTIL_searchFileNamesTable(filenames, stdinmark.as_ptr())
                                                    != -(1 as std::ffi::c_int) && UTIL_isConsole(stdin) != 0
                                            {
                                                if g_displayLevel >= 1 as std::ffi::c_int {
                                                    fprintf(
                                                        stderr,
                                                ...
                                                && UTIL_searchFileNamesTable(filenames, stdinmark.as_ptr())
                                                    != -(1 as std::ffi::c_int) && forceStdout == 0
                                                    ...
                                                    != zom_decompress as std::ffi::c_int as std::ffi::c_uint
                                            {
                                                ...
                                                if showDefaultCParams != 0 {
                                                        ...
                                                        == zom_decompress as std::ffi::c_int as std::ffi::c_uint
                                                    {
                                                        ...
                                                        current_block = 3197027601707010554;
                                                    }
                                                } else {
                                                    current_block = 3197027601707010554;
                                                }
                                                match current_block {
                                                    ...
                                                    _ => {
                                                            ...
                                                            && !patchFromDictFileName.is_null()
                                                        {
                                                            ...
                                                            && (*filenames).tableSize > 1 as std::ffi::c_int as size_t
                                                        {
                                                            if g_displayLevel >= 1 as std::ffi::c_int {
                                                                fprintf(
                                                                    stderr,
                                                            ...
                                                            hasStdout = (!outFileName.is_null()
                                                                && strcmp(outFileName, stdoutmark.as_ptr()) == 0)
                                                                as std::ffi::c_int;
                                                            if hasStdout != 0 && g_displayLevel == 2 as std::ffi::c_int
                                                            {
                                                                g_displayLevel = 1 as std::ffi::c_int;
                                                            }
                                                            ...
                                                            FIO_setPatchFromMode(
                                                                prefs,
                                                                (patchFromDictFileName != NULL as *const std::ffi::c_char)
                                                                    as std::ffi::c_int,
                                                            );
                                                            ...
                                                            if memLimit == 0 as std::ffi::c_int as std::ffi::c_uint {
                                                                if compressionParams.windowLog
                                                                    == 0 as std::ffi::c_int as std::ffi::c_uint
                                                                {
                                                                    memLimit = (1 as std::ffi::c_int as U32)
                                                                        << g_defaultMaxWindowLog;
                                                                } else {
                                                                    memLimit = (1 as std::ffi::c_int as U32)
                                                                ...
                                                                == zom_compress as std::ffi::c_int as std::ffi::c_uint
                                                            {
                                                                ...
                                                                FIO_setNbWorkers(prefs, nbWorkers as std::ffi::c_int);
                                                                FIO_setJobSize(prefs, chunkSize as std::ffi::c_int);
                                                                if g_overlapLog != OVERLAP_LOG_DEFAULT as U32 {
                                                                    FIO_setOverlapLog(prefs, g_overlapLog as std::ffi::c_int);
                                                                }
                                                                FIO_setLdmFlag(prefs, ldmFlag as std::ffi::c_uint);
                                                                FIO_setLdmHashLog(prefs, g_ldmHashLog as std::ffi::c_int);
                                                                FIO_setLdmMinMatch(prefs, g_ldmMinMatch as std::ffi::c_int);
                                                                ...
                                                                if 9 as std::ffi::c_int == strategyBounds.upperBound
                                                                {} else {
                                                                    __assert_fail(
                                                                ...
                                                                == 1 as std::ffi::c_int as size_t && !outFileName.is_null()
                                                            {
