...
extern "C" {
    ...
    fn backtrace(
        __array: *mut *mut std::ffi::c_void,
        __size: std::ffi::c_int,
    ) -> std::ffi::c_int;
    fn backtrace_symbols(
        __array: *const *mut std::ffi::c_void,
        __size: std::ffi::c_int,
...
pub const TXZ_EXTENSION: [std::ffi::c_char; 5] = unsafe {
    *::core::mem::transmute::<&[u8; 5], &[std::ffi::c_char; 5]>(b".txz\0")
};
pub const GZ_EXTENSION: [std::ffi::c_char; 4] = unsafe {
    *::core::mem::transmute::<&[u8; 4], &[std::ffi::c_char; 4]>(b".gz\0")
};
pub const TGZ_EXTENSION: [std::ffi::c_char; 5] = unsafe {
    *::core::mem::transmute::<&[u8; 5], &[std::ffi::c_char; 5]>(b".tgz\0")
};
pub const ZSTD_EXTENSION: [std::ffi::c_char; 5] = unsafe {
    *::core::mem::transmute::<&[u8; 5], &[std::ffi::c_char; 5]>(b".zst\0")
};
pub const TZSTD_EXTENSION: [std::ffi::c_char; 6] = unsafe {
    *::core::mem::transmute::<&[u8; 6], &[std::ffi::c_char; 6]>(b".tzst\0")
};
pub const ZSTD_ALT_EXTENSION: [std::ffi::c_char; 6] = unsafe {
    *::core::mem::transmute::<&[u8; 6], &[std::ffi::c_char; 6]>(b".zstd\0")
};
pub const LZ4_EXTENSION: [std::ffi::c_char; 5] = unsafe {
    *::core::mem::transmute::<&[u8; 5], &[std::ffi::c_char; 5]>(b".lz4\0")
};
pub const TLZ4_EXTENSION: [std::ffi::c_char; 6] = unsafe {
    *::core::mem::transmute::<&[u8; 6], &[std::ffi::c_char; 6]>(b".tlz4\0")
};
pub const ZSTD_SPARSE_DEFAULT: std::ffi::c_int = 1 as std::ffi::c_int;
pub const ZSTD_START_SYMBOLLIST_FRAME: std::ffi::c_int = 2 as std::ffi::c_int;
...
pub const SIGINT: std::ffi::c_int = 2;
pub const SIGILL: std::ffi::c_int = 4 as std::ffi::c_int;
pub const SIGABRT: std::ffi::c_int = 6;
pub const SIGFPE: std::ffi::c_int = 8;
pub const SIGSEGV: std::ffi::c_int = 11;
pub const SIGBUS: std::ffi::c_int = 7 as std::ffi::c_int;
...
pub unsafe extern "C" fn FIO_zlibVersion() -> *const std::ffi::c_char {
    return b"Unsupported\0" as *const u8 as *const std::ffi::c_char;
}
#[no_mangle]
...
pub const DICTSIZE_MAX: std::ffi::c_int = 32 as std::ffi::c_int
    * ((1 as std::ffi::c_int) << 20 as std::ffi::c_int);
pub const DEFAULT_FILE_PERMISSIONS: std::ffi::c_int = S_IRUSR | S_IWUSR | S_IRGRP
...
unsafe extern "C" fn INThandler(mut sig: std::ffi::c_int) {
    if sig == 2 as std::ffi::c_int {} else {
        __assert_fail(
    ...
    if !g_artefact.is_null() {
        if UTIL_isRegularFile(g_artefact) != 0 {} else {
            __assert_fail(
                b"UTIL_isRegularFile(g_artefact)\0" as *const u8
                    as *const std::ffi::c_char,
                b"/home/peter/Dev/zstd-c2rust/programs/fileio.c\0" as *const u8
                    as *const std::ffi::c_char,
...
unsafe extern "C" fn addHandler(mut dstFileName: *const std::ffi::c_char) {
    if UTIL_isRegularFile(dstFileName) != 0 {
        ...
        signal(SIGINT, Some(INThandler as unsafe extern "C" fn(std::ffi::c_int) -> ()));
    } else {
...
pub const MAX_STACK_FRAMES: std::ffi::c_int = 50 as std::ffi::c_int;
unsafe extern "C" fn ABRThandler(mut sig: std::ffi::c_int) {
    let mut name = 0 as *const std::ffi::c_char;
    let mut addrlist: [*mut std::ffi::c_void; 50] = [0 as *mut std::ffi::c_void; 50];
    let mut symbollist = 0 as *mut *mut std::ffi::c_char;
    let mut addrlen: std::ffi::c_int = 0;
    let mut i: std::ffi::c_int = 0;
    match sig {
        SIGABRT => {
            name = b"SIGABRT\0" as *const u8 as *const std::ffi::c_char;
        }
        SIGFPE => {
            name = b"SIGFPE\0" as *const u8 as *const std::ffi::c_char;
        }
        SIGILL => {
            name = b"SIGILL\0" as *const u8 as *const std::ffi::c_char;
        }
        SIGINT => {
            name = b"SIGINT\0" as *const u8 as *const std::ffi::c_char;
        }
        SIGSEGV => {
            name = b"SIGSEGV\0" as *const u8 as *const std::ffi::c_char;
        }
        _ => {
            name = b"UNKNOWN\0" as *const u8 as *const std::ffi::c_char;
        }
    }
    fprintf(
        stderr,
    ...
    free(symbollist as *mut std::ffi::c_void);
    signal(
        sig,
        ::core::mem::transmute::<
            libc::intptr_t,
...
pub unsafe extern "C" fn FIO_addAbortHandler() {
    signal(SIGABRT, Some(ABRThandler as unsafe extern "C" fn(std::ffi::c_int) -> ()));
    signal(SIGFPE, Some(ABRThandler as unsafe extern "C" fn(std::ffi::c_int) -> ()));
    signal(SIGILL, Some(ABRThandler as unsafe extern "C" fn(std::ffi::c_int) -> ()));
    signal(SIGSEGV, Some(ABRThandler as unsafe extern "C" fn(std::ffi::c_int) -> ()));
    signal(SIGBUS, Some(ABRThandler as unsafe extern "C" fn(std::ffi::c_int) -> ()));
}
unsafe extern "C" fn FIO_shouldDisplayFileSummary(
    mut fCtx: *const FIO_ctx_t,
) -> std::ffi::c_int {
    return ((*fCtx).nbFilesTotal <= 1 as std::ffi::c_int
...
pub unsafe extern "C" fn FIO_createPreferences() -> *mut FIO_prefs_t {
    let ret = malloc(::core::mem::size_of::<FIO_prefs_t>() as std::ffi::c_ulong)
        as *mut FIO_prefs_t;
    if ret.is_null() {
...
pub unsafe extern "C" fn FIO_createContext() -> *mut FIO_ctx_t {
    let ret = malloc(::core::mem::size_of::<FIO_ctx_t>() as std::ffi::c_ulong)
        as *mut FIO_ctx_t;
    if ret.is_null() {
        if g_display_prefs.displayLevel >= 1 as std::ffi::c_int {
            fprintf(stderr, b"zstd: \0" as *const u8 as *const std::ffi::c_char);
...
#[no_mangle]
pub unsafe extern "C" fn FIO_setJobSize(
    prefs: *mut FIO_prefs_t,
    mut jobSize: std::ffi::c_int,
) {
    if jobSize != 0 && (*prefs).nbWorkers == 0 as std::ffi::c_int {
...
pub unsafe extern "C" fn FIO_setOverlapLog(
    ...
    if overlapLog != 0 && (*prefs).nbWorkers == 0 as std::ffi::c_int {
        if g_display_prefs.displayLevel >= 2 as std::ffi::c_int {
            fprintf(
                stderr,
...
pub unsafe extern "C" fn FIO_setSrcSizeHint(
    ...
    (*prefs)
        .srcSizeHint = (if (2147483647 as std::ffi::c_int as size_t) < srcSizeHint {
...
pub unsafe extern "C" fn FIO_setAdaptMin(
    ...
    'c_13158: {
        if minCLevel >= ZSTD_minCLevel() {} else {
            __assert_fail(
                b"minCLevel >= ZSTD_minCLevel()\0" as *const u8
                    as *const std::ffi::c_char,
                b"/home/peter/Dev/zstd-c2rust/programs/fileio.c\0" as *const u8
                    as *const std::ffi::c_char,
                433 as std::ffi::c_int as std::ffi::c_uint,
...
pub unsafe extern "C" fn FIO_setLdmFlag(
    prefs: *mut FIO_prefs_t,
    mut ldmFlag: std::ffi::c_uint,
) {
    (*prefs)
        .ldmFlag = (ldmFlag > 0 as std::ffi::c_int as std::ffi::c_uint)
        as std::ffi::c_int;
}
#[no_mangle]
...
unsafe extern "C" fn FIO_removeFile(
    ...
    *bufferPtr = NULL as *mut std::ffi::c_void;
    ...
    if fileHandle.is_null() {
        ...
        if g_display_prefs.displayLevel >= 1 as std::ffi::c_int {
            fprintf(
                stderr,
                b"Couldn't open dictionary %s: %s\0" as *const u8
                    as *const std::ffi::c_char,
                fileName,
                strerror(*__errno_location()),
            );
...
pub unsafe extern "C" fn FIO_checkFilenameCollisions(
    ...
    let mut filenameTableSorted = 0 as *mut *const std::ffi::c_char;
    let mut prevElem = 0 as *const std::ffi::c_char;
    let mut filename = 0 as *const std::ffi::c_char;
    ...
    while u < nbFiles {
        if strcmp(prevElem, *filenameTableSorted.offset(u as isize))
            == 0 as std::ffi::c_int
        {
            if g_display_prefs.displayLevel >= 2 as std::ffi::c_int {
                fprintf(
...
unsafe extern "C" fn extractFilename(
    ...
    let mut search: *const std::ffi::c_char = strrchr(
        path,
    ...
    return search.offset(1 as std::ffi::c_int as isize);
}
unsafe extern "C" fn FIO_createFilename_fromOutDir(
    ...
    let mut filenameStart = 0 as *const std::ffi::c_char;
    let mut separator: std::ffi::c_char = 0;
    let mut result = 0 as *mut std::ffi::c_char;
    ...
    if *outDirName
        .offset(
            (strlen(outDirName)).wrapping_sub(1 as std::ffi::c_int as std::ffi::c_ulong)
                as isize,
        ) as std::ffi::c_int == separator as std::ffi::c_int
    {
        memcpy(
...
unsafe extern "C" fn FIO_highbit64(mut v: std::ffi::c_ulonglong) -> std::ffi::c_uint {
    ...
    if v != 0 as std::ffi::c_int as std::ffi::c_ulonglong {} else {
        __assert_fail(
...
unsafe extern "C" fn FIO_adjustMemLimitForPatchFromMode(
    ...
    if maxSize != -(1 as std::ffi::c_int) as U64 as std::ffi::c_ulonglong {} else {
        __assert_fail(
                ...
                maxWindowSize
                    .wrapping_div(
                        (1 as std::ffi::c_int as std::ffi::c_uint)
                            .wrapping_mul(
                                (1 as std::ffi::c_uint) << 30 as std::ffi::c_int,
                            ),
                    ),
            );
        }
...
unsafe extern "C" fn FIO_multiFilesConcatWarning(
    ...
    if (*fCtx).nbFilesTotal > 1 as std::ffi::c_int {} else {
        __assert_fail(
...
unsafe extern "C" fn ZSTD_cycleLog(mut hashLog: U32, mut strat: ZSTD_strategy) -> U32 {
    ...
    if hashLog > 1 as std::ffi::c_int as U32 {} else {
        __assert_fail(
...
unsafe extern "C" fn FIO_adjustParamsForPatchFromMode(
    ...
    (*comprParams)
        .windowLog = if 10 as std::ffi::c_int as std::ffi::c_uint
            ...
            == 4 as std::ffi::c_int as std::ffi::c_ulong
        {
            ...
            31 as std::ffi::c_int
        }) as std::ffi::c_uint) < fileWindowLog
        {
            (if ::core::mem::size_of::<size_t>() as std::ffi::c_ulong
                == 4 as std::ffi::c_int as std::ffi::c_ulong
            {
...
unsafe extern "C" fn FIO_createCResources(
    ...
    let mut ress = cRess_t {
        ...
        dictFileName: 0 as *const std::ffi::c_char,
        dictFileStat: stat {
            st_dev: 0,
            st_ino: 0,
            st_nlink: 0,
    ...
    if ZSTD_isError(err_21) != 0 {
        if g_display_prefs.displayLevel >= 5 as std::ffi::c_int {
            fprintf(
                stderr,
                b"%s \n\0" as *const u8 as *const std::ffi::c_char,
                b"ZSTD_CCtx_setParameter(ress.cctx, ZSTD_c_jobSize, prefs->jobSize)\0"
                    as *const u8 as *const std::ffi::c_char,
            );
        }
        if g_display_prefs.displayLevel >= 1 as std::ffi::c_int {
...
unsafe extern "C" fn FIO_compressZstdFrame(
    ...
    if fileSize != UTIL_FILESIZE_UNKNOWN as U64 {
        ...
        err_0 = ZSTD_CCtx_setPledgedSrcSize(
            ress.cctx,
            (*prefs).streamSrcSize as std::ffi::c_ulonglong,
        );
        if ZSTD_isError(err_0) != 0 {
            if g_display_prefs.displayLevel >= 5 as std::ffi::c_int {
                fprintf(
    ...
    loop {
        ...
        *readsize = (*readsize as std::ffi::c_ulong).wrapping_add(inSize) as U64 as U64;
                ...
                && stillToFlush != 0 as std::ffi::c_int as size_t
        {
                ...
                && UTIL_clockSpanMicro(lastAdaptTime) > adaptEveryMicro
            {
                ...
                if zfp.currentJobID > 1 as std::ffi::c_int as std::ffi::c_uint {
                    ...
                    if (*prefs).nbWorkers >= 1 as std::ffi::c_int {} else {
                        __assert_fail(
                        ...
                        > ((*prefs).nbWorkers + 1 as std::ffi::c_int) as std::ffi::c_uint
                    {
                            ...
                            == noChange as std::ffi::c_int as std::ffi::c_uint
                        {
                            ...
                            if inputBlocked
                                ...
                                && newlyFlushed_0
                                    .wrapping_mul(
                                        33 as std::ffi::c_int as std::ffi::c_ulonglong,
                                    )
                                    .wrapping_div(
                                        32 as std::ffi::c_int as std::ffi::c_ulonglong,
                                    ) > newlyProduced_0
                                && newlyIngested
                                    .wrapping_mul(
                                        33 as std::ffi::c_int as std::ffi::c_ulonglong,
                    ...
                    || g_display_prefs.displayLevel >= 4 as std::ffi::c_int)
            {
                ...
                let cShare = zfp_0.produced as std::ffi::c_double
                    / (zfp_0.consumed)
                        .wrapping_add(
                            (zfp_0.consumed == 0) as std::ffi::c_int
                                    ...
                                    == FIO_ps_always as std::ffi::c_int as std::ffi::c_uint)
                        {
                            if g_display_prefs.displayLevel >= 1 as std::ffi::c_int {
                                fprintf(
                                    ...
                                    (*fCtx).currFileIdx + 1 as std::ffi::c_int,
                                    (*fCtx).nbFilesTotal,
                                    (18 as std::ffi::c_int as size_t)
                                        .wrapping_sub(srcFileNameSize) as std::ffi::c_int,
                                    srcFileName,
                                );
                            }
                        }
        ...
        if !(directive as std::ffi::c_uint
            != ZSTD_e_end as std::ffi::c_int as std::ffi::c_uint)
        {
            break;
        }
    ...
    return compressedfilesize as std::ffi::c_ulonglong;
}
unsafe extern "C" fn FIO_compressFilename_internal(
    ...
    (*fCtx)
        .totalBytesOutput = ((*fCtx).totalBytesOutput).wrapping_add(compressedfilesize);
    if g_display_prefs.progressSetting as std::ffi::c_uint
        != FIO_ps_never as std::ffi::c_int as std::ffi::c_uint
        && (g_display_prefs.displayLevel >= 2 as std::ffi::c_int
            || g_display_prefs.progressSetting as std::ffi::c_uint
            ...
            if g_display_prefs.displayLevel >= 1 as std::ffi::c_int {
                fprintf(
                    ...
                    b"%-20s :%6.2f%%   (%6.*f%s => %6.*f%s, %s) \n\0" as *const u8
                        as *const std::ffi::c_char,
                    srcFileName,
                    compressedfilesize as std::ffi::c_double
                        / readsize as std::ffi::c_double
                        * 100 as std::ffi::c_int as std::ffi::c_double,
                    hr_isize.precision,
                    hr_isize.value,
                    hr_isize.suffix,
    ...
    let cpuEnd = clock();
    let cpuLoad_s = (cpuEnd - cpuStart) as std::ffi::c_double
        / CLOCKS_PER_SEC as std::ffi::c_double;
    let timeLength_ns = UTIL_clockSpanNano(timeStart);
    let timeLength_s = timeLength_ns as std::ffi::c_double
        / 1000000000 as std::ffi::c_int as std::ffi::c_double;
    let cpuLoad_pct = cpuLoad_s / timeLength_s
        * 100 as std::ffi::c_int as std::ffi::c_double;
    if g_display_prefs.displayLevel >= 4 as std::ffi::c_int {
        fprintf(
            stderr,
...
unsafe extern "C" fn FIO_compressFilename_srcFile(
    ...
    if (*prefs).removeSrcFile != 0 && result == 0 as std::ffi::c_int
...
pub unsafe extern "C" fn FIO_displayCompressionParameters(
    ...
    if g_display_prefs.displayLevel >= 4 as std::ffi::c_int {} else {
        __assert_fail(
            b"g_display_prefs.displayLevel >= 4\0" as *const u8
                as *const std::ffi::c_char,
            b"/home/peter/Dev/zstd-c2rust/programs/fileio.c\0" as *const u8
                as *const std::ffi::c_char,
    ...
    if (*prefs).targetCBlockSize != 0 {
        fprintf(
            stderr,
            b" --target-compressed-block-size=%u\0" as *const u8
                as *const std::ffi::c_char,
...
pub unsafe extern "C" fn FIO_compressMultipleFilenames(
    ...
    if !outFileName.is_null() {
        ...
        if FIO_multiFilesConcatWarning(fCtx, prefs, outFileName, 1 as std::ffi::c_int)
            != 0
        {
            FIO_freeCResources(&mut ress);
            return 1 as std::ffi::c_int;
...
unsafe extern "C" fn FIO_passThrough(mut ress: *mut dRess_t) -> std::ffi::c_int {
    let blockSize = if (if ((64 as std::ffi::c_int
        * ((1 as std::ffi::c_int) << 10 as std::ffi::c_int)) as size_t)
        < ZSTD_DStreamInSize()
    {
        (64 as std::ffi::c_int * ((1 as std::ffi::c_int) << 10 as std::ffi::c_int))
            as size_t
    } else {
        ZSTD_DStreamInSize()
    }) < ZSTD_DStreamOutSize()
    {
        if ((64 as std::ffi::c_int * ((1 as std::ffi::c_int) << 10 as std::ffi::c_int))
            as size_t) < ZSTD_DStreamInSize()
        {
            (64 as std::ffi::c_int * ((1 as std::ffi::c_int) << 10 as std::ffi::c_int))
                as size_t
        } else {
...
unsafe extern "C" fn FIO_zstdErrorHelp(
    ...
    if ZSTD_getErrorCode(err) as std::ffi::c_uint
        != ZSTD_error_frameParameter_windowTooLarge as std::ffi::c_int
            as std::ffi::c_uint
    {
        return;
    }
    ...
    if err == 0 as std::ffi::c_int as size_t {
        ...
        if (*prefs).memLimit > 0 as std::ffi::c_int as std::ffi::c_uint {} else {
            __assert_fail(
        ...
        {
            let windowMB = (windowSize >> 20 as std::ffi::c_int)
                .wrapping_add(
                    (windowSize
                        & (1 as std::ffi::c_int
                            * ((1 as std::ffi::c_int) << 20 as std::ffi::c_int)
...
unsafe extern "C" fn FIO_decompressZstdFrame(
    ...
    {
        srcFName20 = srcFName20
            .offset(
                srcFileLength.wrapping_sub(20 as std::ffi::c_int as size_t) as isize,
            );
    }
    ...
    loop {
        ...
        (*writeJob).usedBufferSize = outBuff.pos;
        AIO_WritePool_enqueueAndReacquireWriteJob(&mut writeJob);
        frameSize = (frameSize as std::ffi::c_ulong).wrapping_add(outBuff.pos) as U64
            as U64;
        if (*fCtx).nbFilesTotal > 1 as std::ffi::c_int {
            if g_display_prefs.progressSetting as std::ffi::c_uint
                != FIO_ps_never as std::ffi::c_int as std::ffi::c_uint
    ...
    AIO_WritePool_releaseIoJob(writeJob);
    AIO_WritePool_sparseWriteEnd((*ress).writeCtx);
    return frameSize as std::ffi::c_ulonglong;
}
unsafe extern "C" fn FIO_decompressFrames(
    ...
    if passThrough == -(1 as std::ffi::c_int) {
        passThrough = ((*prefs).overwrite != 0
            && strcmp(dstFileName, stdoutmark.as_ptr()) == 0) as std::ffi::c_int;
    }
    ...
    loop {
        ...
        if (*ress.readCtx).srcBufferLoaded == 0 as std::ffi::c_int as size_t {
                        ...
                        == 0 as std::ffi::c_int
            {
                ...
                return 1 as std::ffi::c_int;
            } else if MEM_readLE32(buf as *const std::ffi::c_void)
                == LZ4_MAGICNUMBER as U32
            {
                if g_display_prefs.displayLevel >= 1 as std::ffi::c_int {
                    fprintf(
                        stderr,
    ...
    (*fCtx)
        .totalBytesOutput = ((*fCtx).totalBytesOutput).wrapping_add(filesize as size_t);
    if g_display_prefs.progressSetting as std::ffi::c_uint
        != FIO_ps_never as std::ffi::c_int as std::ffi::c_uint
        && (g_display_prefs.displayLevel >= 2 as std::ffi::c_int
            || g_display_prefs.progressSetting as std::ffi::c_uint
...
unsafe extern "C" fn FIO_decompressDstFile(
    ...
    if (AIO_WritePool_getFile(ress.writeCtx)).is_null()
        && (*prefs).testMode == 0 as std::ffi::c_int
    {
        let mut dstFile = 0 as *mut FILE;
...
static mut suffixList: [*const std::ffi::c_char; 4] = [
    ZSTD_EXTENSION.as_ptr(),
    TZSTD_EXTENSION.as_ptr(),
    ZSTD_ALT_EXTENSION.as_ptr(),
    NULL as *const std::ffi::c_char,
];
static mut suffixListStr: *const std::ffi::c_char = b".zst/.tzst\0" as *const u8
    as *const std::ffi::c_char;
unsafe extern "C" fn FIO_determineDstName(
    ...
    let mut matchedSuffixPtr = 0 as *mut *const std::ffi::c_char;
    ...
    if *(*matchedSuffixPtr).offset(1 as std::ffi::c_int as isize) as std::ffi::c_int
        == 't' as i32
    {
...
unsafe extern "C" fn FIO_analyzeFrames(
    ...
    loop {
        ...
        {
            if feof(srcFile) != 0 && numBytesRead == 0 as std::ffi::c_int as size_t
            ...
            if magicNumber == ZSTD_MAGICNUMBER {
                ...
                if frameContentSize as std::ffi::c_ulonglong == ZSTD_CONTENTSIZE_ERROR
                    || frameContentSize as std::ffi::c_ulonglong
                ...
                loop {
                    ...
                    let blockHeader = MEM_readLE24(
                        blockHeaderBuffer.as_mut_ptr() as *const std::ffi::c_void,
                    );
                    let blockTypeID = blockHeader >> 1 as std::ffi::c_int
                        & 3 as std::ffi::c_int as U32;
                    let isRLE = (blockTypeID == 1 as std::ffi::c_int as U32)
                        as std::ffi::c_int as U32;
                    let isWrongBlock = (blockTypeID == 3 as std::ffi::c_int as U32)
                        as std::ffi::c_int as U32;
                    ...
                    lastBlock = (blockHeader & 1 as std::ffi::c_int as U32)
                        as std::ffi::c_int;
                    if fseek(srcFile, blockSize, 1 as std::ffi::c_int)
                        != 0 as std::ffi::c_int
                    {
                        if g_display_prefs.displayLevel >= 1 as std::ffi::c_int {
                            fprintf(
                ...
                let frameHeaderDescriptor = headerBuffer[4 as std::ffi::c_int as usize];
                ...
                == ZSTD_MAGIC_SKIPPABLE_START as std::ffi::c_uint
            {
                let frameSize = MEM_readLE32(
                    headerBuffer.as_mut_ptr().offset(4 as std::ffi::c_int as isize)
                        as *const std::ffi::c_void,
                );
                let seek = ((8 as std::ffi::c_int as U32).wrapping_add(frameSize)
                    as size_t)
...
unsafe extern "C" fn displayInfo(
    ...
    if displayLevel <= 2 as std::ffi::c_int {
        ...
        fprintf(stdout, b"%s \n\0" as *const u8 as *const std::ffi::c_char, inFileName);
        fprintf(
            stdout,
        ...
        if (*info).usesCheck != 0 && (*info).numActualFrames == 1 as std::ffi::c_int {
            fprintf(
                ...
                b"Check: %s %02x%02x%02x%02x\n\0" as *const u8
                    as *const std::ffi::c_char,
                checkString,
                (*info).checksum[3 as std::ffi::c_int as usize] as std::ffi::c_int,
                (*info).checksum[2 as std::ffi::c_int as usize] as std::ffi::c_int,
                (*info).checksum[1 as std::ffi::c_int as usize] as std::ffi::c_int,
                (*info).checksum[0 as std::ffi::c_int as usize] as std::ffi::c_int,
            );
        } else {
            fprintf(
                stdout,
...
unsafe extern "C" fn FIO_listFile(
    ...
    *total = FIO_addFInfo(*total, info);
    if error as std::ffi::c_uint == info_success as std::ffi::c_int as std::ffi::c_uint
        || error as std::ffi::c_uint
            == info_frame_error as std::ffi::c_int as std::ffi::c_uint
    {} else {
        __assert_fail(
    ...
    'c_32452: {
        if error as std::ffi::c_uint
            == info_success as std::ffi::c_int as std::ffi::c_uint
            || error as std::ffi::c_uint
                == info_frame_error as std::ffi::c_int as std::ffi::c_uint
        {} else {
            __assert_fail(
...
pub unsafe extern "C" fn FIO_listMultipleFiles(
    ...
    if numFiles > 1 as std::ffi::c_int as std::ffi::c_uint
        && displayLevel <= 2 as std::ffi::c_int
    {
