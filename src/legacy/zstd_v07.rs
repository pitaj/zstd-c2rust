...
pub const ZSTDv07_MAGIC_SKIPPABLE_START: std::ffi::c_uint = 0x184d2a50
    as std::ffi::c_uint;
...
pub const ZSTDv07_BLOCKSIZE_ABSOLUTEMAX: std::ffi::c_int = 128 as std::ffi::c_int
...
unsafe extern "C" fn MEM_swap32(mut in_0: U32) -> U32 {
    return in_0 << 24 as std::ffi::c_int & 0xff000000 as std::ffi::c_uint
...
unsafe extern "C" fn MEM_swap64(mut in_0: U64) -> U64 {
    return ((in_0 << 56 as std::ffi::c_int) as std::ffi::c_ulonglong
        ...
        | (in_0 >> 56 as std::ffi::c_int) as std::ffi::c_ulonglong
            & 0xff as std::ffi::c_ulonglong) as U64;
}
#[inline]
    ...
    if srcSize >= ::core::mem::size_of::<size_t>() as std::ffi::c_ulong {
        ...
        match srcSize {
            7 => {
                ...
                current_block_20 = 1063717318237579712;
            }
            6 => {
                current_block_20 = 1063717318237579712;
            }
            5 => {
                current_block_20 = 1591380387575923842;
            }
            4 => {
                current_block_20 = 12061037463308077601;
            }
            3 => {
                current_block_20 = 18252126646788143160;
            }
            2 => {
                current_block_20 = 6857029697722191327;
            }
            _ => {
...
pub const FSEv07_MAX_TABLELOG: std::ffi::c_int = FSEv07_MAX_MEMORY_USAGE
    - 2 as std::ffi::c_int;
...
#[no_mangle]
pub unsafe extern "C" fn FSEv07_getErrorName(
    mut code: size_t,
...
#[no_mangle]
pub unsafe extern "C" fn HUFv07_getErrorName(
    mut code: size_t,
) -> *const std::ffi::c_char {
    return ERR_getErrorName(code);
}
...
pub unsafe extern "C" fn FSEv07_readNCount(
    ...
    nbBits = (bitStream & 0xf as std::ffi::c_int as U32)
        .wrapping_add(FSEv07_MIN_TABLELOG as U32) as std::ffi::c_int;
    ...
    while remaining > 1 as std::ffi::c_int && charnum <= *maxSVPtr {
        if previous0 != 0 {
            ...
            while charnum < n0 {
                ...
                *normalizedCounter
                    .offset(fresh0 as isize) = 0 as std::ffi::c_int as std::ffi::c_short;
            }
...
pub unsafe extern "C" fn HUFv07_readStats(
    ...
    while (n_0 as size_t) < oSize {
        if *huffWeight.offset(n_0 as isize) as std::ffi::c_int
...
pub unsafe extern "C" fn FSEv07_createDTable(
    ...
    return malloc(
        ((1 as std::ffi::c_int + ((1 as std::ffi::c_int) << tableLog))
            as std::ffi::c_ulong)
            .wrapping_mul(::core::mem::size_of::<U32>() as std::ffi::c_ulong),
...
pub unsafe extern "C" fn FSEv07_buildDTable(
    ...
    while u < tableSize {
        ...
        (*tableDecode.offset(u as isize))
            ...
            << (*tableDecode.offset(u as isize)).nbBits as std::ffi::c_int) as U32)
...
unsafe extern "C" fn FSEv07_decompress_usingDTable_generic(
        ...
        && op < olimit
    {
        *op
        ...
        if (FSEv07_MAX_TABLELOG * 2 as std::ffi::c_int + 7 as std::ffi::c_int)
            as std::ffi::c_ulong
            > (::core::mem::size_of::<size_t>() as std::ffi::c_ulong)
                .wrapping_mul(8 as std::ffi::c_int as std::ffi::c_ulong)
        {
        ...
        *op
        ...
        if (FSEv07_MAX_TABLELOG * 4 as std::ffi::c_int + 7 as std::ffi::c_int)
            as std::ffi::c_ulong
            > (::core::mem::size_of::<size_t>() as std::ffi::c_ulong)
                .wrapping_mul(8 as std::ffi::c_int as std::ffi::c_ulong)
        {
...
unsafe extern "C" fn HUFv07_decodeStreamX2(
    ...
    while BITv07_reloadDStream(bitDPtr) as std::ffi::c_uint
        == BITv07_DStream_unfinished as std::ffi::c_int as std::ffi::c_uint && p < pEnd
    {
        let fresh14 = p;
        p = p.offset(1);
...
pub unsafe extern "C" fn HUFv07_decompress1X2(
    ...
    let mut DTable: [HUFv07_DTable; 2049] = [
        (12 as std::ffi::c_int - 1 as std::ffi::c_int) as U32
            * 0x1000001 as std::ffi::c_int as U32,
        0,
        0,
        0,
        0,
...
pub unsafe extern "C" fn HUFv07_readDTableX4(
    ...
    *rankStart.offset(0 as std::ffi::c_int as isize) = 0 as std::ffi::c_int as U32;
    let rankVal0 = (rankVal[0 as std::ffi::c_int as usize]).as_mut_ptr();
...
unsafe extern "C" fn HUFv07_decodeStreamX4(
        ...
        && p < pEnd.offset(-(7 as std::ffi::c_int as isize))
    {
        if MEM_64bits() != 0 {
            p = p
                .offset(
                    HUFv07_decodeSymbolX4(p as *mut std::ffi::c_void, bitDPtr, dt, dtLog)
                        as isize,
                );
        }
        if MEM_64bits() != 0 || HUFv07_TABLELOG_MAX <= 12 as std::ffi::c_int {
    ...
    if p < pEnd {
        p = p
            .offset(
                HUFv07_decodeLastSymbolX4(p as *mut std::ffi::c_void, bitDPtr, dt, dtLog)
                    as isize,
            );
    }
...
pub unsafe extern "C" fn HUFv07_decompress1X4(
    ...
    let mut DTable: [HUFv07_DTable; 4097] = [
        12 as std::ffi::c_int as U32 * 0x1000001 as std::ffi::c_int as U32,
        0,
        0,
        0,
        0,
...
#[no_mangle]
pub unsafe extern "C" fn ZSTDv07_getErrorName(
    mut code: size_t,
) -> *const std::ffi::c_char {
    return ERR_getErrorName(code);
}
...
pub unsafe extern "C" fn ZSTDv07_sizeofDCtx(mut dctx: *const ZSTDv07_DCtx) -> size_t {
    return ::core::mem::size_of::<ZSTDv07_DCtx>() as std::ffi::c_ulong;
}
#[no_mangle]
...
pub unsafe extern "C" fn ZSTDv07_decompressBegin(mut dctx: *mut ZSTDv07_DCtx) -> size_t {
    ...
    (*dctx)
        ...
        as usize] = (12 as std::ffi::c_int * 0x1000001 as std::ffi::c_int)
        as HUFv07_DTable;
...
pub unsafe extern "C" fn ZSTDv07_createDCtx_advanced(
    ...
    dctx = (customMem.customAlloc)
        ...
        )(customMem.opaque, ::core::mem::size_of::<ZSTDv07_DCtx>() as std::ffi::c_ulong)
        as *mut ZSTDv07_DCtx;
    if dctx.is_null() {
        return NULL as *mut ZSTDv07_DCtx;
    }
...
pub unsafe extern "C" fn ZSTDv07_freeDCtx(mut dctx: *mut ZSTDv07_DCtx) -> size_t {
    ...
    ((*dctx).customMem.customFree)
        .expect(
            "non-null function pointer",
        )((*dctx).customMem.opaque, dctx as *mut std::ffi::c_void);
    return 0 as std::ffi::c_int as size_t;
}
#[no_mangle]
...
unsafe extern "C" fn ZSTDv07_frameHeaderSize(
    ...
    let directMode = (fhd as std::ffi::c_int >> 5 as std::ffi::c_int
        & 1 as std::ffi::c_int) as U32;
...
pub unsafe extern "C" fn ZSTDv07_getFrameParams(
    ...
    if MEM_readLE32(src) != ZSTDv07_MAGICNUMBER {
        if MEM_readLE32(src) & 0xfffffff0 as std::ffi::c_uint
    ...
    let checksumFlag = (fhdByte as std::ffi::c_int >> 2 as std::ffi::c_int
        & 1 as std::ffi::c_int) as U32;
    let directMode = (fhdByte as std::ffi::c_int >> 5 as std::ffi::c_int
        & 1 as std::ffi::c_int) as U32;
...
unsafe extern "C" fn ZSTDv07_getcBlockSize(
    ...
    (*bpPtr)
        .blockType = (*in_0 as std::ffi::c_int >> 6 as std::ffi::c_int) as blockType_t;
...
unsafe extern "C" fn ZSTDv07_decodeLiteralsBlock(
    ...
    match (*istart.offset(0 as std::ffi::c_int as isize) as std::ffi::c_int
        >> 6 as std::ffi::c_int) as litBlockType_t as std::ffi::c_uint
    {
        0 => {
            let mut litSize: size_t = 0;
            let mut litCSize: size_t = 0;
            let mut singleStream = 0 as std::ffi::c_int as size_t;
            let mut lhSize = (*istart.offset(0 as std::ffi::c_int as isize)
                as std::ffi::c_int >> 4 as std::ffi::c_int & 3 as std::ffi::c_int)
                as U32;
            ...
            match lhSize {
                2 => {
                    ...
                    litSize = (((*istart.offset(0 as std::ffi::c_int as isize)
                        as std::ffi::c_int & 15 as std::ffi::c_int)
                        << 10 as std::ffi::c_int)
                        + ((*istart.offset(1 as std::ffi::c_int as isize)
                            as std::ffi::c_int) << 2 as std::ffi::c_int)
                        + (*istart.offset(2 as std::ffi::c_int as isize)
                            as std::ffi::c_int >> 6 as std::ffi::c_int)) as size_t;
                    litCSize = (((*istart.offset(2 as std::ffi::c_int as isize)
                        as std::ffi::c_int & 63 as std::ffi::c_int)
                        << 8 as std::ffi::c_int)
                        + *istart.offset(3 as std::ffi::c_int as isize)
                            as std::ffi::c_int) as size_t;
                }
                3 => {
                    ...
                    litSize = (((*istart.offset(0 as std::ffi::c_int as isize)
                        ...
                        << 14 as std::ffi::c_int)
                        + ((*istart.offset(1 as std::ffi::c_int as isize)
                            as std::ffi::c_int) << 6 as std::ffi::c_int)
                        + (*istart.offset(2 as std::ffi::c_int as isize)
                            as std::ffi::c_int >> 2 as std::ffi::c_int)) as size_t;
                    litCSize = (((*istart.offset(2 as std::ffi::c_int as isize)
                        as std::ffi::c_int & 3 as std::ffi::c_int)
                        << 16 as std::ffi::c_int)
                        + ((*istart.offset(3 as std::ffi::c_int as isize)
                            as std::ffi::c_int) << 8 as std::ffi::c_int)
                        + *istart.offset(4 as std::ffi::c_int as isize)
                            as std::ffi::c_int) as size_t;
                }
                0 | 1 | _ => {
                    lhSize = 3 as std::ffi::c_int as U32;
                    singleStream = (*istart.offset(0 as std::ffi::c_int as isize)
                        as std::ffi::c_int & 16 as std::ffi::c_int) as size_t;
                    litSize = (((*istart.offset(0 as std::ffi::c_int as isize)
                        as std::ffi::c_int & 15 as std::ffi::c_int)
                        << 6 as std::ffi::c_int)
                        + (*istart.offset(1 as std::ffi::c_int as isize)
        ...
        1 => {
            ...
            let mut lhSize_0 = (*istart.offset(0 as std::ffi::c_int as isize)
                as std::ffi::c_int >> 4 as std::ffi::c_int & 3 as std::ffi::c_int)
                as U32;
            ...
            litSize_0 = (((*istart.offset(0 as std::ffi::c_int as isize)
                as std::ffi::c_int & 15 as std::ffi::c_int) << 6 as std::ffi::c_int)
                + (*istart.offset(1 as std::ffi::c_int as isize) as std::ffi::c_int
                    >> 2 as std::ffi::c_int)) as size_t;
            litCSize_0 = (((*istart.offset(1 as std::ffi::c_int as isize)
                as std::ffi::c_int & 3 as std::ffi::c_int) << 8 as std::ffi::c_int)
        ...
        2 => {
            ...
            let mut lhSize_1 = (*istart.offset(0 as std::ffi::c_int as isize)
                as std::ffi::c_int >> 4 as std::ffi::c_int & 3 as std::ffi::c_int)
                as U32;
            match lhSize_1 {
                2 => {
                ...
                0 | 1 | _ => {
                    ...
                    litSize_1 = (*istart.offset(0 as std::ffi::c_int as isize)
                        as std::ffi::c_int & 31 as std::ffi::c_int) as size_t;
                }
            }
            if (lhSize_1 as size_t)
                .wrapping_add(litSize_1)
                .wrapping_add(WILDCOPY_OVERLENGTH as size_t) > srcSize
            {
        ...
        3 => {
            ...
            let mut lhSize_2 = (*istart.offset(0 as std::ffi::c_int as isize)
                as std::ffi::c_int >> 4 as std::ffi::c_int & 3 as std::ffi::c_int)
                as U32;
            match lhSize_2 {
                2 => {
...
unsafe extern "C" fn ZSTDv07_decodeSeqHeaders(
    ...
    let fresh36 = ip;
    ip = ip.offset(1);
    let mut nbSeq = *fresh36 as std::ffi::c_int;
    if nbSeq == 0 {
...
unsafe extern "C" fn ZSTDv07_decodeSequence(mut seqState: *mut seqState_t) -> seq_t {
    ...
    if ofCode <= 1 as std::ffi::c_int as U32 {
        if (llCode == 0 as std::ffi::c_int as U32) as std::ffi::c_int
            & (offset <= 1 as std::ffi::c_int as size_t) as std::ffi::c_int != 0
        {
        ...
        if offset != 0 {
            ...
            offset = (*seqState).prevOffset[0 as std::ffi::c_int as usize];
        }
    } else {
        (*seqState)
            .prevOffset[2 as std::ffi::c_int
    ...
    seq.offset = offset;
    seq
        .matchLength = (ML_base[mlCode as usize] as size_t)
        .wrapping_add(
    ...
    seq
        .litLength = (LL_base[llCode as usize] as size_t)
        .wrapping_add(
    ...
    *litPtr = iLitEnd;
    ...
    if sequence.offset < 8 as std::ffi::c_int as size_t {
        ...
        *op
        ...
        ZSTDv07_copy8(op as *mut std::ffi::c_void, match_0 as *const std::ffi::c_void);
    }
    op = op.offset(8 as std::ffi::c_int as isize);
    ...
    if oMatchEnd > oend.offset(-((16 as std::ffi::c_int - MINMATCH) as isize)) {
        if op < oend_w {
            ...
            match_0 = match_0
                .offset(oend_w.offset_from(op) as std::ffi::c_long as isize);
            op = oend_w;
        }
        while op < oMatchEnd {
            let fresh40 = match_0;
...
pub unsafe extern "C" fn ZSTDv07_findFrameSizeInfoLegacy(
    ...
    *dBound = (nbBlocks * ZSTDv07_BLOCKSIZE_ABSOLUTEMAX as size_t)
        as std::ffi::c_ulonglong;
}
#[no_mangle]
    ...
    match (*dctx).stage as std::ffi::c_uint {
                ...
                == bt_end as std::ffi::c_int as std::ffi::c_uint
            {
                if (*dctx).fParams.checksumFlag != 0 {
                    ...
                    let h32 = (h64 >> 11 as std::ffi::c_int) as U32
                        & (((1 as std::ffi::c_int) << 22 as std::ffi::c_int)
                            - 1 as std::ffi::c_int) as U32;
                    let ip = src as *const BYTE;
                    let check32 = (*ip.offset(2 as std::ffi::c_int as isize)
                        as std::ffi::c_int
                        + ((*ip.offset(1 as std::ffi::c_int as isize) as std::ffi::c_int)
                            << 8 as std::ffi::c_int)
                        + ((*ip.offset(0 as std::ffi::c_int as isize) as std::ffi::c_int
                            & 0x3f as std::ffi::c_int) << 16 as std::ffi::c_int)) as U32;
                    if check32 != h32 {
        ...
        4 => {
            ...
            (*dctx)
                ...
                ((*dctx).headerBuffer).as_mut_ptr().offset(4 as std::ffi::c_int as isize)
                    as *const std::ffi::c_void,
            ) as size_t;
...
unsafe extern "C" fn ZSTDv07_loadEntropy(
    ...
    if (*dctx).rep[0 as std::ffi::c_int as usize] == 0 as std::ffi::c_int as U32
        || (*dctx).rep[0 as std::ffi::c_int as usize] as size_t >= dictSize
    {
        return -(ZSTD_error_dictionary_corrupted as std::ffi::c_int) as size_t;
    }
    (*dctx)
    ...
    if (*dctx).rep[1 as std::ffi::c_int as usize] == 0 as std::ffi::c_int as U32
        || (*dctx).rep[1 as std::ffi::c_int as usize] as size_t >= dictSize
    {
        return -(ZSTD_error_dictionary_corrupted as std::ffi::c_int) as size_t;
    }
    (*dctx)
    ...
    if (*dctx).rep[2 as std::ffi::c_int as usize] == 0 as std::ffi::c_int as U32
        || (*dctx).rep[2 as std::ffi::c_int as usize] as size_t >= dictSize
    {
        return -(ZSTD_error_dictionary_corrupted as std::ffi::c_int) as size_t;
    }
...
unsafe extern "C" fn ZSTDv07_createDDict_advanced(
    ...
    let ddict = (customMem.customAlloc)
        .expect(
            "non-null function pointer",
        )(customMem.opaque, ::core::mem::size_of::<ZSTDv07_DDict>() as std::ffi::c_ulong)
    ...
    if dictContent.is_null() || ddict.is_null() || dctx.is_null() {
        ...
        (customMem.customFree)
            .expect(
                "non-null function pointer",
            )(customMem.opaque, ddict as *mut std::ffi::c_void);
        (customMem.customFree)
            .expect(
                "non-null function pointer",
            )(customMem.opaque, dctx as *mut std::ffi::c_void);
        return NULL as *mut ZSTDv07_DDict;
    }
...
pub unsafe extern "C" fn ZSTDv07_freeDDict(mut ddict: *mut ZSTDv07_DDict) -> size_t {
    ...
    cFree.expect("non-null function pointer")(opaque, ddict as *mut std::ffi::c_void);
    return 0 as std::ffi::c_int as size_t;
}
#[no_mangle]
...
pub unsafe extern "C" fn ZBUFFv07_createDCtx_advanced(
    ...
    zbd = (customMem.customAlloc)
        .expect(
            "non-null function pointer",
        )(customMem.opaque, ::core::mem::size_of::<ZBUFFv07_DCtx>() as std::ffi::c_ulong)
...
pub unsafe extern "C" fn ZBUFFv07_freeDCtx(mut zbd: *mut ZBUFFv07_DCtx) -> size_t {
    ...
    if !((*zbd).inBuff).is_null() {
        ((*zbd).customMem.customFree)
            .expect(
                "non-null function pointer",
            )((*zbd).customMem.opaque, (*zbd).inBuff as *mut std::ffi::c_void);
    }
    if !((*zbd).outBuff).is_null() {
        ((*zbd).customMem.customFree)
            .expect(
                "non-null function pointer",
            )((*zbd).customMem.opaque, (*zbd).outBuff as *mut std::ffi::c_void);
    }
    ((*zbd).customMem.customFree)
        .expect(
            "non-null function pointer",
        )((*zbd).customMem.opaque, zbd as *mut std::ffi::c_void);
    return 0 as std::ffi::c_int as size_t;
}
#[no_mangle]
            ...
            1 => {
                ...
                if hSize != 0 as std::ffi::c_int as size_t {
                    ...
                    if toLoad > iend.offset_from(ip) as std::ffi::c_long as size_t {
                        if !ip.is_null() {
                            memcpy(
                                ((*zbd).headerBuffer)
                                    .as_mut_ptr()
                                    .offset((*zbd).lhSize as isize) as *mut std::ffi::c_void,
                                ip as *const std::ffi::c_void,
                                iend.offset_from(ip) as std::ffi::c_long
                                    as std::ffi::c_ulong,
                            );
                        }
                        (*zbd)
                    ...
                    let neededOutSize = ((*zbd).fParams.windowSize as size_t)
                        ...
                        .wrapping_add(
                            (WILDCOPY_OVERLENGTH * 2 as std::ffi::c_int) as size_t,
                        );
        ...
        match current_block_66 {
            14945149239039849694 => {
                ...
                loadedSize = ZBUFFv07_limitCopy(
                    ((*zbd).inBuff).offset((*zbd).inPos as isize)
                        as *mut std::ffi::c_void,
                    toLoad_0,
                    ip as *const std::ffi::c_void,
                    iend.offset_from(ip) as std::ffi::c_long as size_t,
