...
pub struct ZSTDv01_Dctx_s {
    ...
    pub previousDstEnd: *mut std::ffi::c_void,
...
pub type C2RustUnnamed_3 = std::ffi::c_uint;
pub const FSE_OK_NoError: C2RustUnnamed_3 = 0;
pub type C2RustUnnamed_4 = std::ffi::c_uint;
...
unsafe extern "C" fn FSE_read32(mut memPtr: *const std::ffi::c_void) -> U32 {
    let mut val: U32 = 0;
    memcpy(
...
unsafe extern "C" fn FSE_read64(mut memPtr: *const std::ffi::c_void) -> U64 {
    let mut val: U64 = 0;
    memcpy(
...
unsafe extern "C" fn FSE_readLE16(mut memPtr: *const std::ffi::c_void) -> U16 {
...
unsafe extern "C" fn FSE_readLE32(mut memPtr: *const std::ffi::c_void) -> U32 {
    if FSE_isLittleEndian() != 0 {
...
unsafe extern "C" fn FSE_readLE64(mut memPtr: *const std::ffi::c_void) -> U64 {
    if FSE_isLittleEndian() != 0 {
...
unsafe extern "C" fn FSE_readLEST(mut memPtr: *const std::ffi::c_void) -> size_t {
    if FSE_32bits() != 0 {
...
#[inline(always)]
unsafe extern "C" fn FSE_highbit32(mut val: U32) -> std::ffi::c_uint {
...
unsafe extern "C" fn FSE_buildDTable(
    ...
    let tableDecode = (ptr as *mut FSE_decode_t).offset(1 as std::ffi::c_int as isize);
    ...
    if maxSymbolValue > FSE_MAX_SYMBOL_VALUE as std::ffi::c_uint {
        return -(FSE_ERROR_maxSymbolValue_tooLarge as std::ffi::c_int) as size_t;
    }
    if tableLog > FSE_MAX_TABLELOG as std::ffi::c_uint {
        return -(FSE_ERROR_tableLog_tooLarge as std::ffi::c_int) as size_t;
    }
    (*DTableH.offset(0 as std::ffi::c_int as isize)).tableLog = tableLog as U16;
    ...
    if position != 0 as std::ffi::c_int as U32 {
        return -(FSE_ERROR_GENERIC as std::ffi::c_int) as size_t;
    }
    let mut i_0: U32 = 0;
...
unsafe extern "C" fn FSE_isError(mut code: size_t) -> std::ffi::c_uint {
    return (code > -(FSE_ERROR_maxCode as std::ffi::c_int) as size_t) as std::ffi::c_int
        as std::ffi::c_uint;
}
...
unsafe extern "C" fn FSE_readNCount(
    ...
    if hbSize < 4 as std::ffi::c_int as size_t {
        return -(FSE_ERROR_srcSize_wrong as std::ffi::c_int) as size_t;
    }
    bitStream = FSE_readLE32(ip as *const std::ffi::c_void);
        ...
        if previous0 != 0 {
                ...
                == 0xffff as std::ffi::c_int as U32
            {
                ...
                if ip < iend.offset(-(5 as std::ffi::c_int as isize)) {
                    ...
                    bitStream = FSE_readLE32(ip as *const std::ffi::c_void) >> bitCount;
                } else {
            ...
            bitCount += 2 as std::ffi::c_int;
            if n0 > *maxSVPtr {
                return -(FSE_ERROR_maxSymbolValue_tooSmall as std::ffi::c_int) as size_t;
            }
            while charnum < n0 {
                let fresh2 = charnum;
...
unsafe extern "C" fn FSE_buildDTable_rle(
    ...
    let mut ptr = dt as *mut std::ffi::c_void;
    let DTableH = ptr as *mut FSE_DTableHeader;
    let cell = (ptr as *mut FSE_decode_t).offset(1 as std::ffi::c_int as isize);
...
unsafe extern "C" fn FSE_buildDTable_raw(
    ...
    let mut ptr = dt as *mut std::ffi::c_void;
    let DTableH = ptr as *mut FSE_DTableHeader;
    let dinfo = (ptr as *mut FSE_decode_t).offset(1 as std::ffi::c_int as isize);
...
unsafe extern "C" fn FSE_initDStream(
    ...
    if srcSize >= ::core::mem::size_of::<size_t>() as std::ffi::c_ulong {
        ...
        (*bitD).bitContainer = FSE_readLEST((*bitD).ptr as *const std::ffi::c_void);
        ...
        match srcSize {
            7 => {
                ...
                current_block_19 = 9155435906777149716;
            }
            6 => {
                current_block_19 = 9155435906777149716;
            }
            5 => {
                current_block_19 = 13897942385253891774;
            }
            4 => {
                current_block_19 = 363388766274477776;
            }
            3 => {
                current_block_19 = 820927060201197550;
            }
            2 => {
                current_block_19 = 7135052081263186708;
            }
            _ => {
...
unsafe extern "C" fn FSE_reloadDStream(
    mut bitD: *mut FSE_DStream_t,
) -> std::ffi::c_uint {
    if (*bitD).bitsConsumed as std::ffi::c_ulong
        > (::core::mem::size_of::<size_t>() as std::ffi::c_ulong)
            .wrapping_mul(8 as std::ffi::c_int as std::ffi::c_ulong)
    {
        return FSE_DStream_tooFar as std::ffi::c_int as std::ffi::c_uint;
    }
    if (*bitD).ptr
        >= ((*bitD).start)
            .offset(::core::mem::size_of::<size_t>() as std::ffi::c_ulong as isize)
    {
        ...
        (*bitD).bitContainer = FSE_readLEST((*bitD).ptr as *const std::ffi::c_void);
        return FSE_DStream_unfinished as std::ffi::c_int as std::ffi::c_uint;
    }
    if (*bitD).ptr == (*bitD).start {
        if ((*bitD).bitsConsumed as std::ffi::c_ulong)
            < (::core::mem::size_of::<size_t>() as std::ffi::c_ulong)
                .wrapping_mul(8 as std::ffi::c_int as std::ffi::c_ulong)
        {
            return FSE_DStream_endOfBuffer as std::ffi::c_int as std::ffi::c_uint;
        }
        return FSE_DStream_completed as std::ffi::c_int as std::ffi::c_uint;
    }
    let mut nbBytes = (*bitD).bitsConsumed >> 3 as std::ffi::c_int;
    let mut result = FSE_DStream_unfinished as std::ffi::c_int as U32;
    if ((*bitD).ptr).offset(-(nbBytes as isize)) < (*bitD).start {
        nbBytes = ((*bitD).ptr).offset_from((*bitD).start) as std::ffi::c_long as U32;
        result = FSE_DStream_endOfBuffer as std::ffi::c_int as U32;
    }
...
unsafe extern "C" fn FSE_endOfDStream(
    mut bitD: *const FSE_DStream_t,
) -> std::ffi::c_uint {
    return ((*bitD).ptr == (*bitD).start
        && (*bitD).bitsConsumed as std::ffi::c_ulong
            == (::core::mem::size_of::<size_t>() as std::ffi::c_ulong)
                .wrapping_mul(8 as std::ffi::c_int as std::ffi::c_ulong))
...
unsafe extern "C" fn FSE_decompress_usingDTable_generic(
    ...
    while FSE_reloadDStream(&mut bitD)
        == FSE_DStream_unfinished as std::ffi::c_int as std::ffi::c_uint && op < olimit
    {
        *op
            .offset(
        ...
        *op
                ...
                .wrapping_mul(8 as std::ffi::c_int as std::ffi::c_ulong)
        {
            if FSE_reloadDStream(&mut bitD)
                > FSE_DStream_unfinished as std::ffi::c_int as std::ffi::c_uint
            {
    ...
    while !(FSE_reloadDStream(&mut bitD)
        > FSE_DStream_completed as std::ffi::c_int as std::ffi::c_uint || op == omax
    ...
    if op == omax {
        return -(FSE_ERROR_dstSize_tooSmall as std::ffi::c_int) as size_t;
    }
    return -(FSE_ERROR_corruptionDetected as std::ffi::c_int) as size_t;
}
...
unsafe extern "C" fn HUF_readDTable(
    ...
    let mut ptr = DTable.offset(1 as std::ffi::c_int as isize) as *mut std::ffi::c_void;
    ...
    if iSize >= 128 as std::ffi::c_int as size_t {
        if iSize >= 242 as std::ffi::c_int as size_t {
            ...
            oSize = l[iSize.wrapping_sub(242 as std::ffi::c_int as size_t) as usize]
                as size_t;
            memset(
                huffWeight.as_mut_ptr() as *mut std::ffi::c_void,
                1 as std::ffi::c_int,
                ::core::mem::size_of::<[BYTE; 256]>() as std::ffi::c_ulong,
            );
            ...
            while (n as size_t) < oSize {
                huffWeight[n
                    as usize] = (*ip.offset((n / 2 as std::ffi::c_int as U32) as isize)
                    as std::ffi::c_int >> 4 as std::ffi::c_int) as BYTE;
                huffWeight[n.wrapping_add(1 as std::ffi::c_int as U32)
                    as usize] = (*ip.offset((n / 2 as std::ffi::c_int as U32) as isize)
    ...
    n = 0 as std::ffi::c_int as U32;
    while (n as size_t) < oSize {
        if huffWeight[n as usize] as std::ffi::c_int >= HUF_ABSOLUTEMAX_TABLELOG {
            return -(FSE_ERROR_corruptionDetected as std::ffi::c_int) as size_t;
        }
        ...
        weightTotal = weightTotal
            .wrapping_add(
                ((1 as std::ffi::c_int) << huffWeight[n as usize] as std::ffi::c_int
    ...
    if maxBits > *DTable.offset(0 as std::ffi::c_int as isize) as U32 {
        return -(FSE_ERROR_tableLog_tooLarge as std::ffi::c_int) as size_t;
    }
    *DTable.offset(0 as std::ffi::c_int as isize) = maxBits as U16;
    let mut total = ((1 as std::ffi::c_int) << maxBits) as U32;
    let mut rest = total.wrapping_sub(weightTotal);
    let mut verif = ((1 as std::ffi::c_int) << FSE_highbit32(rest)) as U32;
    ...
    rankVal[lastWeight as usize];
    if rankVal[1 as std::ffi::c_int as usize] < 2 as std::ffi::c_int as U32
        || rankVal[1 as std::ffi::c_int as usize] & 1 as std::ffi::c_int as U32 != 0
    {
        return -(FSE_ERROR_corruptionDetected as std::ffi::c_int) as size_t;
    }
    ...
    while n as size_t <= oSize {
        ...
        D.byte = n as BYTE;
        D
            .nbBits = maxBits.wrapping_add(1 as std::ffi::c_int as U32).wrapping_sub(w)
            as BYTE;
...
unsafe extern "C" fn HUF_decompress_usingDTable(
    ...
    if cSrcSize < 6 as std::ffi::c_int as size_t {
        return -(FSE_ERROR_srcSize_wrong as std::ffi::c_int) as size_t;
    }
    let ostart = dst as *mut BYTE;
    let mut op = ostart;
    let omax = op.offset(maxDstSize as isize);
    let olimit = if maxDstSize < 15 as std::ffi::c_int as size_t {
        op
    } else {
        omax.offset(-(15 as std::ffi::c_int as isize))
    };
    let mut ptr = DTable as *const std::ffi::c_void;
    let dt = (ptr as *const HUF_DElt).offset(1 as std::ffi::c_int as isize);
    let dtLog = *DTable.offset(0 as std::ffi::c_int as isize) as U32;
    let mut errorCode: size_t = 0;
    let mut reloadStatus: U32 = 0;
    let mut jumpTable = cSrc as *const U16;
    let length1 = FSE_readLE16(jumpTable as *const std::ffi::c_void) as size_t;
    let length2 = FSE_readLE16(
        jumpTable.offset(1 as std::ffi::c_int as isize) as *const std::ffi::c_void,
    ) as size_t;
    let length3 = FSE_readLE16(
        jumpTable.offset(2 as std::ffi::c_int as isize) as *const std::ffi::c_void,
    ) as size_t;
    let length4 = cSrcSize
        .wrapping_sub(6 as std::ffi::c_int as size_t)
        .wrapping_sub(length1)
        .wrapping_sub(length2)
        .wrapping_sub(length3);
    let start1 = (cSrc as *const std::ffi::c_char).offset(6 as std::ffi::c_int as isize);
    ...
    if length1
        ...
        .wrapping_add(6 as std::ffi::c_int as size_t) >= cSrcSize
    {
        return -(FSE_ERROR_srcSize_wrong as std::ffi::c_int) as size_t;
    }
    errorCode = FSE_initDStream(&mut bitD1, start1 as *const std::ffi::c_void, length1);
    if FSE_isError(errorCode) != 0 {
        return errorCode;
    }
    errorCode = FSE_initDStream(&mut bitD2, start2 as *const std::ffi::c_void, length2);
    if FSE_isError(errorCode) != 0 {
        return errorCode;
    }
    errorCode = FSE_initDStream(&mut bitD3, start3 as *const std::ffi::c_void, length3);
    if FSE_isError(errorCode) != 0 {
        return errorCode;
    }
    errorCode = FSE_initDStream(&mut bitD4, start4 as *const std::ffi::c_void, length4);
    if FSE_isError(errorCode) != 0 {
        return errorCode;
    }
    reloadStatus = FSE_reloadDStream(&mut bitD2);
    while reloadStatus < FSE_DStream_completed as std::ffi::c_int as U32 && op < olimit {
        *op
            .offset(
                0 as std::ffi::c_int as isize,
            ) = HUF_decodeSymbol(&mut bitD1, dt, dtLog);
        if FSE_32bits() != 0 && HUF_MAX_TABLELOG > 12 as std::ffi::c_int {
            FSE_reloadDStream(&mut bitD1);
        }
        *op
            .offset(
                1 as std::ffi::c_int as isize,
            ) = HUF_decodeSymbol(&mut bitD2, dt, dtLog);
        if FSE_32bits() != 0 && HUF_MAX_TABLELOG > 12 as std::ffi::c_int {
        ...
        *op
            .offset(
                2 as std::ffi::c_int as isize,
            ) = HUF_decodeSymbol(&mut bitD3, dt, dtLog);
        if FSE_32bits() != 0 && HUF_MAX_TABLELOG > 12 as std::ffi::c_int {
        ...
        *op
            .offset(
                3 as std::ffi::c_int as isize,
            ) = HUF_decodeSymbol(&mut bitD4, dt, dtLog);
        if FSE_32bits() != 0 && HUF_MAX_TABLELOG > 12 as std::ffi::c_int {
        ...
        *op
            .offset(
                12 as std::ffi::c_int as isize,
            ) = HUF_decodeSymbol(&mut bitD1, dt, dtLog);
        *op
            .offset(
                13 as std::ffi::c_int as isize,
            ) = HUF_decodeSymbol(&mut bitD2, dt, dtLog);
        *op
            .offset(
                14 as std::ffi::c_int as isize,
            ) = HUF_decodeSymbol(&mut bitD3, dt, dtLog);
        *op
            .offset(
                15 as std::ffi::c_int as isize,
            ) = HUF_decodeSymbol(&mut bitD4, dt, dtLog);
    ...
    if reloadStatus != FSE_DStream_completed as std::ffi::c_int as U32 {
        return -(FSE_ERROR_corruptionDetected as std::ffi::c_int) as size_t;
    }
...
static mut ZSTD_magicNumber: U32 = 0xfd2fb51e as std::ffi::c_uint;
...
static mut ZSTD_frameHeaderSize: size_t = 4 as std::ffi::c_int as size_t;
unsafe extern "C" fn ZSTD_32bits() -> std::ffi::c_uint {
    return (::core::mem::size_of::<*mut std::ffi::c_void>() as std::ffi::c_ulong
        == 4 as std::ffi::c_int as std::ffi::c_ulong) as std::ffi::c_int
        as std::ffi::c_uint;
}
unsafe extern "C" fn ZSTD_isLittleEndian() -> std::ffi::c_uint {
    let one = C2RustUnnamed {
        i: 1 as std::ffi::c_int as U32,
    };
    return one.c[0 as std::ffi::c_int as usize] as std::ffi::c_uint;
}
unsafe extern "C" fn ZSTD_read16(mut p: *const std::ffi::c_void) -> U16 {
    let mut r: U16 = 0;
    memcpy(
        &mut r as *mut U16 as *mut std::ffi::c_void,
        p,
        ::core::mem::size_of::<U16>() as std::ffi::c_ulong,
    );
    return r;
...
unsafe extern "C" fn ZSTD_readLE16(mut memPtr: *const std::ffi::c_void) -> U16 {
    if ZSTD_isLittleEndian() != 0 {
        return ZSTD_read16(memPtr)
    } else {
        let mut p = memPtr as *const BYTE;
        return (*p.offset(0 as std::ffi::c_int as isize) as U16 as std::ffi::c_int
            + ((*p.offset(1 as std::ffi::c_int as isize) as U16 as std::ffi::c_int)
                << 8 as std::ffi::c_int)) as U16;
    };
}
unsafe extern "C" fn ZSTD_readLE24(mut memPtr: *const std::ffi::c_void) -> U32 {
    return (ZSTD_readLE16(memPtr) as std::ffi::c_int
        + ((*(memPtr as *const BYTE).offset(2 as std::ffi::c_int as isize)
            as std::ffi::c_int) << 16 as std::ffi::c_int)) as U32;
}
unsafe extern "C" fn ZSTD_readBE32(mut memPtr: *const std::ffi::c_void) -> U32 {
    let mut p = memPtr as *const BYTE;
    return ((*p.offset(0 as std::ffi::c_int as isize) as U32) << 24 as std::ffi::c_int)
        .wrapping_add(
            (*p.offset(1 as std::ffi::c_int as isize) as U32) << 16 as std::ffi::c_int,
        )
        .wrapping_add(
            (*p.offset(2 as std::ffi::c_int as isize) as U32) << 8 as std::ffi::c_int,
        )
        .wrapping_add(
            (*p.offset(3 as std::ffi::c_int as isize) as U32) << 0 as std::ffi::c_int,
        );
}
#[no_mangle]
pub unsafe extern "C" fn ZSTDv01_isError(mut code: size_t) -> std::ffi::c_uint {
...
unsafe extern "C" fn ZSTD_decompressLiterals(
    ...
    litSize = (*ip.offset(1 as std::ffi::c_int as isize) as std::ffi::c_int
        + ((*ip.offset(0 as std::ffi::c_int as isize) as std::ffi::c_int)
            << 8 as std::ffi::c_int)) as size_t;
    litSize = litSize
        .wrapping_add(
            ((*ip.offset(-(3 as std::ffi::c_int) as isize) as std::ffi::c_int
                >> 3 as std::ffi::c_int & 7 as std::ffi::c_int) << 16 as std::ffi::c_int)
                as size_t,
        );
    ...
    errorCode = HUF_decompress(
        ...
        srcSize.wrapping_sub(2 as std::ffi::c_int as size_t),
    );
    if FSE_isError(errorCode) != 0 {
...
unsafe extern "C" fn ZSTDv01_decodeLiteralsBlock(
    ...
    match litbp.blockType as std::ffi::c_uint {
        1 => {
            *litStart = ip;
        ...
        2 => {
            ...
            if rleSize > 0 as std::ffi::c_int as size_t {
                memset(
                    oend.offset(-(rleSize as isize)) as *mut std::ffi::c_void,
                    *ip as std::ffi::c_int,
                    rleSize,
                );
            }
        ...
        3 | _ => return -(ZSTD_error_GENERIC as std::ffi::c_int) as size_t,
    }
    return ip.offset_from(istart) as std::ffi::c_long as size_t;
}
unsafe extern "C" fn ZSTDv01_decodeSeqHeaders(
    ...
    *nbSeq = ZSTD_readLE16(ip as *const std::ffi::c_void) as std::ffi::c_int;
    ip = ip.offset(2 as std::ffi::c_int as isize);
...
unsafe extern "C" fn ZSTD_decodeSequence(
    ...
    if litLength == MaxLL as size_t {
        let add = (if dumps < de {
            ...
            *fresh9 as std::ffi::c_int
        } else {
            0 as std::ffi::c_int
        }) as U32;
        if add < 255 as std::ffi::c_int as U32 {
            litLength = litLength.wrapping_add(add as size_t);
        } else if dumps <= de.offset(-(3 as std::ffi::c_int as isize)) {
            litLength = ZSTD_readLE24(dumps as *const std::ffi::c_void) as size_t;
    ...
    offset = ((1 as std::ffi::c_int as size_t)
        << (nbBits as std::ffi::c_ulong
            & (::core::mem::size_of::<size_t>() as std::ffi::c_ulong)
                .wrapping_mul(8 as std::ffi::c_int as std::ffi::c_ulong)
    ...
    if matchLength == MaxML as size_t {
        ...
        if add_0 < 255 as std::ffi::c_int as U32 {
            ...
            matchLength = ZSTD_readLE24(dumps as *const std::ffi::c_void) as size_t;
            dumps = dumps.offset(3 as std::ffi::c_int as isize);
        }
    }
...
unsafe extern "C" fn ZSTD_execSequence(
    ...
    if sequence.offset > oLitEnd.offset_from(base) as std::ffi::c_long as U32 as size_t {
        return -(ZSTD_error_corruption_detected as std::ffi::c_int) as size_t;
    }
    if endMatch > oend {
        return -(ZSTD_error_dstSize_tooSmall as std::ffi::c_int) as size_t;
    ...
    if sequence.matchLength > (*litPtr).offset_from(op) as std::ffi::c_long as size_t {
        return -(ZSTD_error_dstSize_tooSmall as std::ffi::c_int) as size_t;
    }
    libc::memmove(
        op as *mut std::ffi::c_void,
    ...
    *litPtr = litEnd;
    ...
    let overlapRisk = ((litEnd.offset_from(endMatch) as std::ffi::c_long as size_t)
        < 12 as std::ffi::c_int as size_t) as std::ffi::c_int as U32;
    let mut match_0: *const BYTE = op.offset(-(sequence.offset as isize));
    let mut qutt = 12 as std::ffi::c_int as size_t;
    ...
    if overlapRisk != 0 {
        if endMatch.offset(qutt as isize) > oend {
            qutt = oend.offset_from(endMatch) as std::ffi::c_long as size_t;
        }
        memcpy(
            saved.as_mut_ptr() as *mut std::ffi::c_void,
            endMatch as *const std::ffi::c_void,
            qutt,
        );
    }
    ...
    if endMatch > oend.offset(-((16 as std::ffi::c_int - MINMATCH) as isize)) {
        if op < oend.offset(-(8 as std::ffi::c_int as isize)) {
            ZSTD_wildcopy(
                op as *mut std::ffi::c_void,
                match_0 as *const std::ffi::c_void,
                oend.offset(-(8 as std::ffi::c_int as isize)).offset_from(op)
                    as std::ffi::c_long,
            );
            match_0 = match_0
                .offset(
            ...
            op = oend.offset(-(8 as std::ffi::c_int as isize));
        }
        while op < endMatch {
            let fresh11 = match_0;
    ...
    if overlapRisk != 0 {
        memcpy(
            endMatch as *mut std::ffi::c_void,
            saved.as_mut_ptr() as *const std::ffi::c_void,
            qutt,
        );
    }
    return endMatch.offset_from(ostart) as std::ffi::c_long as size_t;
}
unsafe extern "C" fn ZSTD_decompressSequences(
    ...
    seqState.prevOffset = 1 as std::ffi::c_int as size_t;
    ...
    while FSE_reloadDStream(&mut seqState.DStream)
        <= FSE_DStream_completed as std::ffi::c_int as std::ffi::c_uint
...
pub unsafe extern "C" fn ZSTDv01_decompressDCtx(
    ...
    let mut errorCode = 0 as std::ffi::c_int as size_t;
    ...
    loop {
        ...
        if blockSize == 0 as std::ffi::c_int as size_t {
            break;
        }
        if ZSTDv01_isError(errorCode) != 0 {
            return errorCode;
...
pub unsafe extern "C" fn ZSTDv01_decompress(
    ...
    let mut ctx = ZSTDv01_Dctx_s {
        LLTable: [0; 1025],
        OffTable: [0; 513],
        MLTable: [0; 1025],
        previousDstEnd: 0 as *mut std::ffi::c_void,
        base: 0 as *mut std::ffi::c_void,
        expected: 0,
        bType: bt_compressed,
        phase: 0,
    };
    ...
    return ZSTDv01_decompressDCtx(
        &mut ctx as *mut dctx_t as *mut std::ffi::c_void,
        dst,
        maxDstSize,
        src,
        srcSize,
...
pub unsafe extern "C" fn ZSTDv01_resetDCtx(mut dctx: *mut ZSTDv01_Dctx) -> size_t {
    ...
    (*dctx).phase = 0 as std::ffi::c_int as U32;
    (*dctx).previousDstEnd = NULL as *mut std::ffi::c_void;
    (*dctx).base = NULL as *mut std::ffi::c_void;
    return 0 as std::ffi::c_int as size_t;
}
#[no_mangle]
pub unsafe extern "C" fn ZSTDv01_createDCtx() -> *mut ZSTDv01_Dctx {
    let mut dctx = malloc(::core::mem::size_of::<ZSTDv01_Dctx>() as std::ffi::c_ulong)
        as *mut ZSTDv01_Dctx;
    if dctx.is_null() {
...
pub unsafe extern "C" fn ZSTDv01_decompressContinue(
    ...
    if (*ctx).phase == 0 as std::ffi::c_int as U32 {
        let mut magicNumber = ZSTD_readBE32(src);
        if magicNumber != ZSTD_magicNumber {
            return -(ZSTD_error_prefix_unknown as std::ffi::c_int) as size_t;
        }
        (*ctx).phase = 1 as std::ffi::c_int as U32;
        (*ctx).expected = ZSTD_blockHeaderSize;
        return 0 as std::ffi::c_int as size_t;
    }
    if (*ctx).phase == 1 as std::ffi::c_int as U32 {
            ...
            == bt_end as std::ffi::c_int as std::ffi::c_uint
        {
            ...
            (*ctx).phase = 0 as std::ffi::c_int as U32;
        } else {
            (*ctx).expected = blockSize;
            (*ctx).bType = bp.blockType;
            (*ctx).phase = 2 as std::ffi::c_int as U32;
        }
        return 0 as std::ffi::c_int as size_t;
    }
