...
pub type ZSTDv06_dStage = libc::c_uint;
...
pub type FSEv06_DTable = libc::c_uint;
#[derive(Copy, Clone)]
#[repr(C)]
...
pub type BITv06_DStream_status = libc::c_uint;
...
pub type ZBUFFv06_dStage = libc::c_uint;
...
pub const ZSTDv06_MAGICNUMBER: libc::c_uint = 0xfd2fb526 as libc::c_uint;
...
pub const ZSTDv06_FRAMEHEADERSIZE_MAX: libc::c_int = 13 as libc::c_int;
static mut ZSTDv06_frameHeaderSize_min: libc::size_t = 5 as libc::c_int as libc::size_t;
static mut ZSTDv06_frameHeaderSize_max: libc::size_t = ZSTDv06_FRAMEHEADERSIZE_MAX as libc::size_t;
pub const ZSTDv06_BLOCKSIZE_MAX: libc::c_int = 128 as libc::c_int * 1024;
pub const ZSTDv06_DICT_MAGIC: libc::c_uint = 0xec30a436 as libc::c_uint;
pub const ZSTDv06_REP_NUM: libc::c_int = 3 as libc::c_int;
pub const ZSTDv06_REP_INIT: libc::c_int = 3 as libc::c_int;
pub const ZSTDv06_REP_MOVE: libc::c_int = ZSTDv06_REP_NUM - 1 as libc::c_int;
pub const ZSTDv06_WINDOWLOG_ABSOLUTEMIN: libc::c_int = 12 as libc::c_int;
static mut ZSTDv06_fcs_fieldSize: [libc::size_t; 4] = [
    0 as libc::c_int as libc::size_t,
    1 as libc::c_int as libc::size_t,
    2 as libc::c_int as libc::size_t,
    8 as libc::c_int as libc::size_t,
];
pub const ZSTDv06_BLOCKHEADERSIZE: libc::c_int = 3 as libc::c_int;
static mut ZSTDv06_blockHeaderSize: libc::size_t = ZSTDv06_BLOCKHEADERSIZE as libc::size_t;
...
pub const FSEv06_ENCODING_RAW: libc::c_int = 0;
pub const FSEv06_ENCODING_RLE: libc::c_int = 1;
pub const FSEv06_ENCODING_STATIC: libc::c_int = 2;
pub const FSEv06_ENCODING_DYNAMIC: libc::c_int = 3;
...
unsafe extern "C" fn ZSTDv06_copy8(mut dst: *mut libc::c_void, mut src: *const libc::c_void) {
...
unsafe extern "C" fn ZSTDv06_wildcopy(
    ...
    loop {
        ZSTDv06_copy8(op as *mut libc::c_void, ip as *const libc::c_void);
        op = op.offset(8);
        ip = ip.offset(8);
        if !(op < oend) {
            break;
...
unsafe extern "C" fn BITv06_highbit32(mut val: u32) -> libc::c_uint {
...
unsafe extern "C" fn BITv06_initDStream(
    ...
    if srcSize >= ::core::mem::size_of::<libc::size_t>() {
        ...
        (*bitD).bitsConsumed = (8).wrapping_sub(BITv06_highbit32(lastByte as u32));
    } else {
        (*bitD).start = srcBuffer as *const libc::c_char;
        (*bitD).ptr = (*bitD).start;
        ...
        match srcSize {
            7 => {
                ...
                current_block_20 = 7282908690880421722;
            }
            6 => {
                current_block_20 = 7282908690880421722;
            }
            5 => {
                current_block_20 = 13116085205790050649;
            }
            4 => {
                current_block_20 = 13400121500224309998;
            }
            3 => {
                current_block_20 = 10649213382288798138;
            }
            2 => {
                current_block_20 = 2712775926561343283;
            }
            _ => {
        ...
        (*bitD).bitsConsumed = (8).wrapping_sub(BITv06_highbit32(lastByte_0 as u32));
...
unsafe extern "C" fn BITv06_lookBits(
...
unsafe extern "C" fn BITv06_readBits(
    mut bitD: *mut BITv06_DStream_t,
    mut nbBits: u32,
) -> libc::size_t {
...
unsafe extern "C" fn BITv06_endOfDStream(mut DStream: *const BITv06_DStream_t) -> libc::c_uint {
...
unsafe extern "C" fn FSEv06_initDState(
    ...
    (*DStatePtr).state = BITv06_readBits(bitD, (*DTableH).tableLog as libc::c_uint);
    BITv06_reloadDStream(bitD);
    (*DStatePtr).table = dt.offset(1) as *const libc::c_void;
}
unsafe extern "C" fn FSEv06_peekSymbol(mut DStatePtr: *const FSEv06_DState_t) -> u8 {
...
pub const FSEv06_MAX_MEMORY_USAGE: libc::c_int = 14 as libc::c_int;
pub const FSEv06_MAX_SYMBOL_VALUE: libc::c_int = 255 as libc::c_int;
pub const FSEv06_MAX_TABLELOG: libc::c_int = FSEv06_MAX_MEMORY_USAGE - 2 as libc::c_int;
pub const FSEv06_MIN_TABLELOG: libc::c_int = 5 as libc::c_int;
pub const FSEv06_TABLELOG_ABSOLUTE_MAX: libc::c_int = 15 as libc::c_int;
#[export_name = "FSEv06_isError"]
pub unsafe extern "C" fn FSEv06_isError_1(mut code: libc::size_t) -> libc::c_uint {
    return ERR_isError(code);
}
#[no_mangle]
pub unsafe extern "C" fn FSEv06_getErrorName(mut code: libc::size_t) -> *const libc::c_char {
    return ERR_getErrorName(code);
}
unsafe extern "C" fn HUFv06_isError(mut code: libc::size_t) -> libc::c_uint {
    return ERR_isError(code);
}
unsafe extern "C" fn FSEv06_abs(mut a: libc::c_short) -> libc::c_short {
...
pub unsafe extern "C" fn FSEv06_readNCount(
    ...
    nbBits = (bitStream & 0xf as libc::c_int as libc::c_uint)
        .wrapping_add(FSEv06_MIN_TABLELOG as libc::c_uint) as libc::c_int;
    ...
    *tableLogPtr = nbBits as libc::c_uint;
    ...
    while remaining > 1 && charnum <= *maxSVPtr {
        ...
        count -= 1;
        remaining -= FSEv06_abs(count) as libc::c_int;
        let fresh1 = charnum;
        charnum = charnum.wrapping_add(1);
...
pub const FSEv06_isError_0: unsafe extern "C" fn(libc::size_t) -> libc::c_uint = ERR_isError;
#[no_mangle]
pub unsafe extern "C" fn FSEv06_createDTable(mut tableLog: libc::c_uint) -> *mut FSEv06_DTable {
    if tableLog > FSEv06_TABLELOG_ABSOLUTE_MAX as libc::c_uint {
        tableLog = FSEv06_TABLELOG_ABSOLUTE_MAX as libc::c_uint;
    }
    return malloc(
...
pub unsafe extern "C" fn FSEv06_buildDTable(
    ...
    if maxSymbolValue > FSEv06_MAX_SYMBOL_VALUE as libc::c_uint {
        return -(ZSTD_error_maxSymbolValue_tooLarge as libc::c_int) as libc::size_t;
    }
    if tableLog > FSEv06_MAX_TABLELOG as libc::c_uint {
        return -(ZSTD_error_tableLog_tooLarge as libc::c_int) as libc::size_t;
    }
    ...
    memcpy(
        ...
        &mut DTableH as *mut FSEv06_DTableHeader as *const libc::c_void,
...
unsafe extern "C" fn FSEv06_decompress_usingDTable_generic(
    ...
    while BITv06_reloadDStream(&mut bitD) as libc::c_uint
        == BITv06_DStream_unfinished as libc::c_int as libc::c_uint
        && op < olimit
    {
        *op.offset(0 as libc::c_int as isize) = (if fast != 0 {
            FSEv06_decodeSymbolFast(&mut state1, &mut bitD) as libc::c_int
        } else {
            FSEv06_decodeSymbol(&mut state1, &mut bitD) as libc::c_int
        }) as u8;
        if (FSEv06_MAX_TABLELOG * 2 + 7) as libc::c_ulong
            > (::core::mem::size_of::<libc::size_t>()).wrapping_mul(8)
        {
            BITv06_reloadDStream(&mut bitD);
        }
        *op.offset(1 as libc::c_int as isize) = (if fast != 0 {
            FSEv06_decodeSymbolFast(&mut state2, &mut bitD) as libc::c_int
        } else {
            FSEv06_decodeSymbol(&mut state2, &mut bitD) as libc::c_int
        }) as u8;
        if (FSEv06_MAX_TABLELOG * 4 + 7) as libc::c_ulong
            > (::core::mem::size_of::<libc::size_t>()).wrapping_mul(8)
        {
            if BITv06_reloadDStream(&mut bitD) as libc::c_uint
                > BITv06_DStream_unfinished as libc::c_int as libc::c_uint
            {
                op = op.offset(2);
                break;
    ...
    loop {
        ...
        *fresh4 = (if fast != 0 {
        ...
        if BITv06_reloadDStream(&mut bitD) as libc::c_uint
            == BITv06_DStream_overflow as libc::c_int as libc::c_uint
        {
            let fresh5 = op;
            op = op.offset(1);
            *fresh5 = (if fast != 0 {
...
pub unsafe extern "C" fn FSEv06_decompress(
    ...
    let mut maxSymbolValue = FSEv06_MAX_SYMBOL_VALUE as libc::c_uint;
    if cSrcSize < 2 {
        return -(ZSTD_error_srcSize_wrong as libc::c_int) as libc::size_t;
    }
...
pub const HUFv06_ABSOLUTEMAX_TABLELOG: libc::c_int = 16 as libc::c_int;
pub const HUFv06_MAX_TABLELOG: libc::c_int = 12 as libc::c_int;
pub const HUFv06_MAX_SYMBOL_VALUE: libc::c_int = 255 as libc::c_int;
unsafe extern "C" fn HUFv06_readStats(
    ...
    memset(
        ...
        0 as libc::c_int,
        ((HUFv06_ABSOLUTEMAX_TABLELOG + 1) as libc::c_ulong)
            .wrapping_mul(::core::mem::size_of::<u32>()),
    );
    ...
    while (n_0 as libc::c_ulong) < oSize {
        if *huffWeight.offset(n_0 as isize) as libc::c_int >= HUFv06_ABSOLUTEMAX_TABLELOG {
            return -(ZSTD_error_corruption_detected as libc::c_int) as libc::size_t;
        }
        let ref mut fresh8 = *rankStats.offset(*huffWeight.offset(n_0 as isize) as isize);
    ...
    if tableLog > HUFv06_ABSOLUTEMAX_TABLELOG as libc::c_uint {
        return -(ZSTD_error_corruption_detected as libc::c_int) as libc::size_t;
    }
    ...
    *huffWeight.offset(oSize as isize) = lastWeight as u8;
    let ref mut fresh9 = *rankStats.offset(lastWeight as isize);
...
pub unsafe extern "C" fn HUFv06_readDTableX2(
    ...
    iSize = HUFv06_readStats(
        ...
        (HUFv06_MAX_SYMBOL_VALUE + 1) as libc::size_t,
        rankVal.as_mut_ptr(),
        &mut nbSymbols,
        &mut tableLog,
        src,
...
unsafe extern "C" fn HUFv06_decodeStreamX2(
    ...
    let pStart = p;
    while BITv06_reloadDStream(bitDPtr) as libc::c_uint
        == BITv06_DStream_unfinished as libc::c_int as libc::c_uint
        && p <= pEnd.offset(-(4))
    {
        if MEM_64bits() != 0 {
            let fresh10 = p;
            p = p.offset(1);
            *fresh10 = HUFv06_decodeSymbolX2(bitDPtr, dt, dtLog);
        }
        if MEM_64bits() != 0 || HUFv06_MAX_TABLELOG <= 12 {
            let fresh11 = p;
            p = p.offset(1);
            *fresh11 = HUFv06_decodeSymbolX2(bitDPtr, dt, dtLog);
        }
        if MEM_64bits() != 0 {
            let fresh12 = p;
            p = p.offset(1);
...
pub unsafe extern "C" fn HUFv06_decompress1X2(
    ...
    return HUFv06_decompress1X2_usingDTable(
        dst,
        dstSize,
        ip as *const libc::c_void,
        cSrcSize,
...
pub unsafe extern "C" fn HUFv06_decompress4X2_usingDTable(
    ...
    errorCode = BITv06_initDStream(&mut bitD1, istart1 as *const libc::c_void, length1);
    if HUFv06_isError(errorCode) != 0 {
        return errorCode;
    }
    errorCode = BITv06_initDStream(&mut bitD2, istart2 as *const libc::c_void, length2);
    if HUFv06_isError(errorCode) != 0 {
        return errorCode;
    }
    errorCode = BITv06_initDStream(&mut bitD3, istart3 as *const libc::c_void, length3);
    if HUFv06_isError(errorCode) != 0 {
        return errorCode;
    }
    errorCode = BITv06_initDStream(&mut bitD4, istart4 as *const libc::c_void, length4);
    if HUFv06_isError(errorCode) != 0 {
        return errorCode;
    }
    endSignal = BITv06_reloadDStream(&mut bitD1) as libc::c_uint
        | BITv06_reloadDStream(&mut bitD2) as libc::c_uint
        | BITv06_reloadDStream(&mut bitD3) as libc::c_uint
        | BITv06_reloadDStream(&mut bitD4) as libc::c_uint;
    while endSignal == BITv06_DStream_unfinished as libc::c_int as libc::c_uint
        && op4 < oend.offset(-(7))
    {
        if MEM_64bits() != 0 {
            let fresh16 = op1;
            op1 = op1.offset(1);
            *fresh16 = HUFv06_decodeSymbolX2(&mut bitD1, dt, dtLog);
        }
        if MEM_64bits() != 0 {
            let fresh17 = op2;
            op2 = op2.offset(1);
            *fresh17 = HUFv06_decodeSymbolX2(&mut bitD2, dt, dtLog);
        }
        if MEM_64bits() != 0 {
            let fresh18 = op3;
            op3 = op3.offset(1);
            *fresh18 = HUFv06_decodeSymbolX2(&mut bitD3, dt, dtLog);
        }
        if MEM_64bits() != 0 {
            let fresh19 = op4;
            op4 = op4.offset(1);
            *fresh19 = HUFv06_decodeSymbolX2(&mut bitD4, dt, dtLog);
        }
        if MEM_64bits() != 0 || HUFv06_MAX_TABLELOG <= 12 {
            let fresh20 = op1;
            op1 = op1.offset(1);
            *fresh20 = HUFv06_decodeSymbolX2(&mut bitD1, dt, dtLog);
        }
        if MEM_64bits() != 0 || HUFv06_MAX_TABLELOG <= 12 {
            let fresh21 = op2;
            op2 = op2.offset(1);
            *fresh21 = HUFv06_decodeSymbolX2(&mut bitD2, dt, dtLog);
        }
        if MEM_64bits() != 0 || HUFv06_MAX_TABLELOG <= 12 {
            let fresh22 = op3;
            op3 = op3.offset(1);
            *fresh22 = HUFv06_decodeSymbolX2(&mut bitD3, dt, dtLog);
        }
        if MEM_64bits() != 0 || HUFv06_MAX_TABLELOG <= 12 {
            let fresh23 = op4;
            op4 = op4.offset(1);
            *fresh23 = HUFv06_decodeSymbolX2(&mut bitD4, dt, dtLog);
        }
        if MEM_64bits() != 0 {
            let fresh24 = op1;
            op1 = op1.offset(1);
            *fresh24 = HUFv06_decodeSymbolX2(&mut bitD1, dt, dtLog);
        }
        if MEM_64bits() != 0 {
            let fresh25 = op2;
            op2 = op2.offset(1);
            *fresh25 = HUFv06_decodeSymbolX2(&mut bitD2, dt, dtLog);
        }
        if MEM_64bits() != 0 {
            let fresh26 = op3;
            op3 = op3.offset(1);
            *fresh26 = HUFv06_decodeSymbolX2(&mut bitD3, dt, dtLog);
        }
        if MEM_64bits() != 0 {
            let fresh27 = op4;
            op4 = op4.offset(1);
            *fresh27 = HUFv06_decodeSymbolX2(&mut bitD4, dt, dtLog);
        }
        let fresh28 = op1;
        op1 = op1.offset(1);
        *fresh28 = HUFv06_decodeSymbolX2(&mut bitD1, dt, dtLog);
        let fresh29 = op2;
        op2 = op2.offset(1);
        *fresh29 = HUFv06_decodeSymbolX2(&mut bitD2, dt, dtLog);
        let fresh30 = op3;
        op3 = op3.offset(1);
        *fresh30 = HUFv06_decodeSymbolX2(&mut bitD3, dt, dtLog);
        let fresh31 = op4;
        op4 = op4.offset(1);
        *fresh31 = HUFv06_decodeSymbolX2(&mut bitD4, dt, dtLog);
        endSignal = BITv06_reloadDStream(&mut bitD1) as libc::c_uint
            | BITv06_reloadDStream(&mut bitD2) as libc::c_uint
            | BITv06_reloadDStream(&mut bitD3) as libc::c_uint
            | BITv06_reloadDStream(&mut bitD4) as libc::c_uint;
...
pub unsafe extern "C" fn HUFv06_decompress4X2(
    ...
    ip = ip.offset(errorCode as isize);
    cSrcSize = (cSrcSize as libc::c_ulong).wrapping_sub(errorCode);
    return HUFv06_decompress4X2_usingDTable(
        dst,
        dstSize,
        ip as *const libc::c_void,
        cSrcSize,
...
pub unsafe extern "C" fn HUFv06_readDTableX4(
    ...
    if memLog > HUFv06_ABSOLUTEMAX_TABLELOG as libc::c_uint {
        return -(ZSTD_error_tableLog_tooLarge as libc::c_int) as libc::size_t;
    }
    iSize = HUFv06_readStats(
...
unsafe extern "C" fn HUFv06_decodeStreamX4(
        ...
        && p < pEnd.offset(-(7))
    {
        if MEM_64bits() != 0 {
            p = p
                .offset(HUFv06_decodeSymbolX4(p as *mut libc::c_void, bitDPtr, dt, dtLog) as isize);
        }
        if MEM_64bits() != 0 || HUFv06_MAX_TABLELOG <= 12 {
            p = p
                .offset(HUFv06_decodeSymbolX4(p as *mut libc::c_void, bitDPtr, dt, dtLog) as isize);
        ...
        p = p.offset(HUFv06_decodeSymbolX4(p as *mut libc::c_void, bitDPtr, dt, dtLog) as isize);
    }
    while BITv06_reloadDStream(bitDPtr) as libc::c_uint
        == BITv06_DStream_unfinished as libc::c_int as libc::c_uint
        && p <= pEnd.offset(-(2))
    ...
    if p < pEnd {
        p = p
            .offset(HUFv06_decodeLastSymbolX4(p as *mut libc::c_void, bitDPtr, dt, dtLog) as isize);
    }
...
pub unsafe extern "C" fn HUFv06_decompress1X4_usingDTable(
    ...
    let errorCode = BITv06_initDStream(&mut bitD, istart as *const libc::c_void, cSrcSize);
    if HUFv06_isError(errorCode) != 0 {
        return errorCode;
    }
...
pub unsafe extern "C" fn HUFv06_decompress1X4(
    ...
    return HUFv06_decompress1X4_usingDTable(
        dst,
        dstSize,
        ip as *const libc::c_void,
        cSrcSize,
...
pub unsafe extern "C" fn HUFv06_decompress4X4_usingDTable(
        ...
        && op4 < oend.offset(-(7))
    {
        if MEM_64bits() != 0 {
            op1 = op1.offset(
                HUFv06_decodeSymbolX4(op1 as *mut libc::c_void, &mut bitD1, dt, dtLog) as isize,
            );
        }
        if MEM_64bits() != 0 {
            op2 = op2.offset(
                HUFv06_decodeSymbolX4(op2 as *mut libc::c_void, &mut bitD2, dt, dtLog) as isize,
            );
        }
        if MEM_64bits() != 0 {
            op3 = op3.offset(
                HUFv06_decodeSymbolX4(op3 as *mut libc::c_void, &mut bitD3, dt, dtLog) as isize,
            );
        }
        if MEM_64bits() != 0 {
            op4 = op4.offset(
                HUFv06_decodeSymbolX4(op4 as *mut libc::c_void, &mut bitD4, dt, dtLog) as isize,
            );
        }
        if MEM_64bits() != 0 || HUFv06_MAX_TABLELOG <= 12 {
            op1 = op1.offset(
...
pub unsafe extern "C" fn HUFv06_decompress4X4(
    ...
    ip = ip.offset(hSize as isize);
    cSrcSize = (cSrcSize as libc::c_ulong).wrapping_sub(hSize);
    return HUFv06_decompress4X4_usingDTable(
        dst,
        dstSize,
        ip as *const libc::c_void,
        cSrcSize,
...
pub unsafe extern "C" fn ZSTDv06_isError_0(mut code: libc::size_t) -> libc::c_uint {
    return ERR_isError(code);
}
#[no_mangle]
pub unsafe extern "C" fn ZSTDv06_getErrorName(mut code: libc::size_t) -> *const libc::c_char {
    return ERR_getErrorName(code);
}
#[no_mangle]
pub unsafe extern "C" fn ZBUFFv06_isError(mut errorCode: libc::size_t) -> libc::c_uint {
    return ERR_isError(errorCode);
}
#[no_mangle]
pub unsafe extern "C" fn ZBUFFv06_getErrorName(mut errorCode: libc::size_t) -> *const libc::c_char {
    return ERR_getErrorName(errorCode);
}
pub const ZSTDv06_isError: unsafe extern "C" fn(libc::size_t) -> libc::c_uint = ERR_isError;
pub const FSEv06_isError: unsafe extern "C" fn(libc::size_t) -> libc::c_uint = ERR_isError;
pub const HUFv06_isError_0: unsafe extern "C" fn(libc::size_t) -> libc::c_uint = ERR_isError;
unsafe extern "C" fn ZSTDv06_copy4(mut dst: *mut libc::c_void, mut src: *const libc::c_void) {
    memcpy(dst, src, 4 as libc::c_int as libc::c_ulong);
}
#[no_mangle]
pub unsafe extern "C" fn ZSTDv06_sizeofDCtx() -> libc::size_t {
    return ::core::mem::size_of::<ZSTDv06_DCtx>();
}
#[no_mangle]
pub unsafe extern "C" fn ZSTDv06_decompressBegin(mut dctx: *mut ZSTDv06_DCtx) -> libc::size_t {
    ...
    (*dctx).flagRepeatTable = 0 as libc::c_int as u32;
    return 0 as libc::c_int as libc::size_t;
}
#[no_mangle]
pub unsafe extern "C" fn ZSTDv06_createDCtx() -> *mut ZSTDv06_DCtx {
    let mut dctx = malloc(::core::mem::size_of::<ZSTDv06_DCtx>()) as *mut ZSTDv06_DCtx;
    if dctx.is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn ZSTDv06_freeDCtx(mut dctx: *mut ZSTDv06_DCtx) -> libc::size_t {
...
pub unsafe extern "C" fn ZSTDv06_copyDCtx(
    ...
    memcpy(
        ...
        (::core::mem::size_of::<ZSTDv06_DCtx>()).wrapping_sub(
            ((ZSTDv06_BLOCKSIZE_MAX + WILDCOPY_OVERLENGTH) as libc::c_ulong)
...
unsafe extern "C" fn ZSTDv06_frameHeaderSize(
    ...
    let fcsId = (*(src as *const u8).offset(4) as libc::c_int >> 6 as libc::c_int) as u32;
...
pub unsafe extern "C" fn ZSTDv06_getFrameParams(
    ...
    (*fparamsPtr).windowLog = ((frameDesc as libc::c_int & 0xf as libc::c_int)
        + ZSTDv06_WINDOWLOG_ABSOLUTEMIN) as libc::c_uint;
    if frameDesc as libc::c_int & 0x20 as libc::c_int != 0 as libc::c_int {
        return -(ZSTD_error_frameParameter_unsupported as libc::c_int) as libc::size_t;
    }
    let mut current_block_14: u64;
    match frameDesc as libc::c_int >> 6 as libc::c_int {
        0 => {
            current_block_14 = 2149107243143984000;
        }
        1 => {
            (*fparamsPtr).frameContentSize = *ip.offset(5) as libc::c_ulonglong;
            current_block_14 = 17407779659766490442;
        }
        2 => {
            (*fparamsPtr).frameContentSize = (MEM_readLE16(ip.offset(5) as *const libc::c_void)
                as libc::c_int
                + 256) as libc::c_ulonglong;
            current_block_14 = 17407779659766490442;
        }
        3 => {
            (*fparamsPtr).frameContentSize =
                MEM_readLE64(ip.offset(5) as *const libc::c_void) as libc::c_ulonglong;
            current_block_14 = 17407779659766490442;
        }
        _ => {
            current_block_14 = 2149107243143984000;
    ...
    match current_block_14 {
        2149107243143984000 => {
            (*fparamsPtr).frameContentSize = 0 as libc::c_int as libc::c_ulonglong;
        }
        _ => {}
    }
    return 0 as libc::c_int as libc::size_t;
...
unsafe extern "C" fn ZSTDv06_decodeLiteralsBlock(
    ...
    match *istart.offset(0) as libc::c_int >> 6 as libc::c_int {
        IS_HUF => {
            ...
            if litSize > ZSTDv06_BLOCKSIZE_MAX as libc::c_ulong {
                return -(ZSTD_error_corruption_detected as libc::c_int) as libc::size_t;
            }
        ...
        IS_RLE => {
            ...
            if litSize_2 > ZSTDv06_BLOCKSIZE_MAX as libc::c_ulong {
                return -(ZSTD_error_corruption_detected as libc::c_int) as libc::size_t;
            }
            memset(
                ((*dctx).litBuffer).as_mut_ptr() as *mut libc::c_void,
...
unsafe extern "C" fn ZSTDv06_decodeSeqHeaders(
    ...
    let fresh35 = ip;
    ip = ip.offset(1);
    let mut nbSeq = *fresh35 as libc::c_int;
    if nbSeq == 0 {
    ...
    if nbSeq > 0x7f as libc::c_int {
        if nbSeq == 0xff as libc::c_int {
            ...
            let fresh36 = ip;
            ip = ip.offset(1);
            nbSeq = ((nbSeq - 0x80 as libc::c_int) << 8 as libc::c_int) + *fresh36 as libc::c_int;
        }
    }
    *nbSeqPtr = nbSeq;
    if ip.offset(4) > iend {
    ...
    let Offtype = (*ip as libc::c_int >> 4 as libc::c_int & 3) as u32;
...
unsafe extern "C" fn ZSTDv06_decodeSequence(mut seq: *mut seq_t, mut seqState: *mut seqState_t) {
    ...
    static mut ML_base: [u32; 53] = [
        ...
        36 as libc::c_int as u32,
        38 as libc::c_int as u32,
        40 as libc::c_int as u32,
        44 as libc::c_int as u32,
        48 as libc::c_int as u32,
        56 as libc::c_int as u32,
        64 as libc::c_int as u32,
        80 as libc::c_int as u32,
        96 as libc::c_int as u32,
        0x80 as libc::c_int as u32,
        0x100 as libc::c_int as u32,
        0x200 as libc::c_int as u32,
        0x400 as libc::c_int as u32,
    ...
    static mut OF_base: [u32; 29] = [
        ...
        0x1ff as libc::c_int as u32,
        0x3ff as libc::c_int as u32,
        0x7ff as libc::c_int as u32,
        0xfff as libc::c_int as u32,
        0x1fff as libc::c_int as u32,
        0x3fff as libc::c_int as u32,
        0x7fff as libc::c_int as u32,
        0xffff as libc::c_int as u32,
        0x1ffff as libc::c_int as u32,
        0x3ffff as libc::c_int as u32,
        0x7ffff as libc::c_int as u32,
        0xfffff as libc::c_int as u32,
        0x1fffff as libc::c_int as u32,
        0x3fffff as libc::c_int as u32,
        0x7fffff as libc::c_int as u32,
        0xffffff as libc::c_int as u32,
        0x1ffffff as libc::c_int as u32,
        0x3ffffff as libc::c_int as u32,
        1 as libc::c_int as u32,
        1 as libc::c_int as u32,
    ];
    ...
    if offset < ZSTDv06_REP_NUM as libc::c_ulong {
        if llCode == 0 && offset <= 1 {
            offset = (1).wrapping_sub(offset);
        }
        if offset != 0 as libc::c_int as libc::c_ulong {
            let mut temp = (*seqState).prevOffset[offset as usize];
        ...
        offset = (offset as libc::c_ulong).wrapping_sub(ZSTDv06_REP_MOVE as libc::c_ulong);
        (*seqState).prevOffset[2 as libc::c_int as usize] =
            (*seqState).prevOffset[1 as libc::c_int as usize];
        (*seqState).prevOffset[1 as libc::c_int as usize] =
            (*seqState).prevOffset[0 as libc::c_int as usize];
    ...
    (*seq).offset = offset;
    (*seq).matchLength = ((ML_base[mlCode as usize]).wrapping_add(MINMATCH as libc::c_uint)
        as libc::c_ulong)
        .wrapping_add(
            (if mlCode > 31 {
    ...
    *litPtr = iLitEnd;
    ...
    if sequence.offset < 8 {
        ...
        *op.offset(3 as libc::c_int as isize) = *match_0.offset(3);
        ...
        ZSTDv06_copy8(op as *mut libc::c_void, match_0 as *const libc::c_void);
    }
    op = op.offset(8);
...
unsafe extern "C" fn ZSTDv06_decompressSequences(
    ...
    if nbSeq != 0 {
        ...
        let mut i: u32 = 0;
        i = 0 as libc::c_int as u32;
        while i < ZSTDv06_REP_INIT as libc::c_uint {
            seqState.prevOffset[i as usize] = REPCODE_STARTVALUE as libc::size_t;
            i = i.wrapping_add(1);
        }
        ...
        while BITv06_reloadDStream(&mut seqState.DStream) as libc::c_uint
            <= BITv06_DStream_completed as libc::c_int as libc::c_uint
            && nbSeq != 0
        {
            nbSeq -= 1;
...
unsafe extern "C" fn ZSTDv06_decompressBlock_internal(
    ...
    let mut ip = src as *const u8;
    if srcSize >= ZSTDv06_BLOCKSIZE_MAX as libc::c_ulong {
        return -(ZSTD_error_srcSize_wrong as libc::c_int) as libc::size_t;
    }
    ...
    return ZSTDv06_decompressSequences(dctx, dst, dstCapacity, ip as *const libc::c_void, srcSize);
}
#[no_mangle]
...
unsafe extern "C" fn ZSTDv06_decompressFrame(
    ...
    let mut blockProperties = {
        let mut init = blockProperties_t {
            blockType: bt_compressed,
            origSize: 0 as libc::c_int as u32,
        };
        init
    };
    ...
    loop {
        ...
        remainingSize = (remainingSize as libc::c_ulong).wrapping_sub(ZSTDv06_blockHeaderSize);
...
pub unsafe extern "C" fn ZSTDv06_decompressDCtx(
    ...
    return ZSTDv06_decompress_usingDict(
        dctx,
        dst,
        dstCapacity,
        src,
...
pub unsafe extern "C" fn ZSTDv06_findFrameSizeInfoLegacy(
    ...
    *dBound = nbBlocks.wrapping_mul(ZSTDv06_BLOCKSIZE_MAX as libc::c_ulong) as libc::c_ulonglong;
}
#[no_mangle]
pub unsafe extern "C" fn ZSTDv06_nextSrcSizeToDecompress(
    mut dctx: *mut ZSTDv06_DCtx,
) -> libc::size_t {
...
pub unsafe extern "C" fn ZSTDv06_decompressContinue(
    ...
    memcpy(
        ((*dctx).headerBuffer)
            .as_mut_ptr()
            .offset(ZSTDv06_frameHeaderSize_min as isize) as *mut libc::c_void,
        src,
        (*dctx).expected,
    );
...
unsafe extern "C" fn ZSTDv06_loadEntropy(
    ...
    (*dctx).flagRepeatTable = 1 as libc::c_int as u32;
    return hSize
...
pub unsafe extern "C" fn ZBUFFv06_createDCtx() -> *mut ZBUFFv06_DCtx {
    let mut zbd = malloc(::core::mem::size_of::<ZBUFFv06_DCtx>()) as *mut ZBUFFv06_DCtx;
    if zbd.is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn ZBUFFv06_freeDCtx(mut zbd: *mut ZBUFFv06_DCtx) -> libc::size_t {
    if zbd.is_null() {
        return 0 as libc::c_int as libc::size_t;
    }
    ZSTDv06_freeDCtx((*zbd).zd);
    free((*zbd).inBuff as *mut libc::c_void);
    free((*zbd).outBuff as *mut libc::c_void);
    free(zbd as *mut libc::c_void);
    return 0 as libc::c_int as libc::size_t;
}
#[no_mangle]
...
#[no_mangle]
pub unsafe extern "C" fn ZBUFFv06_decompressInit(mut zbd: *mut ZBUFFv06_DCtx) -> libc::size_t {
    return ZBUFFv06_decompressInitDictionary(
        zbd,
        NULL as *const libc::c_void,
        0 as libc::c_int as libc::size_t,
    );
...
pub unsafe extern "C" fn ZBUFFv06_decompressContinue(
            ...
            1 => {
                ...
                if hSize != 0 as libc::c_int as libc::c_ulong {
                    ...
                    let blockSize = (if (1) << (*zbd).fParams.windowLog < 128 * 1024 {
                        ...
                        128 as libc::c_int * 1024
                    }) as libc::size_t;
                    (*zbd).blockSize = blockSize;
                    if (*zbd).inBuffSize < blockSize {
                        free((*zbd).inBuff as *mut libc::c_void);
                        (*zbd).inBuffSize = blockSize;
                        (*zbd).inBuff = malloc(blockSize) as *mut libc::c_char;
                        if ((*zbd).inBuff).is_null() {
                            return -(ZSTD_error_memory_allocation as libc::c_int) as libc::size_t;
                        }
                    }
                    let neededOutSize = ((1) << (*zbd).fParams.windowLog)
                        .wrapping_add(blockSize)
                        .wrapping_add((WILDCOPY_OVERLENGTH * 2) as libc::c_ulong);
                    if (*zbd).outBuffSize < neededOutSize {
                        free((*zbd).outBuff as *mut libc::c_void);
                        (*zbd).outBuffSize = neededOutSize;
                        (*zbd).outBuff = malloc(neededOutSize) as *mut libc::c_char;
    ...
    *dstCapacityPtr = op.offset_from(ostart) as libc::c_long as libc::size_t;
    ...
    if nextSrcSizeHint > ZSTDv06_blockHeaderSize {
        nextSrcSizeHint = (nextSrcSizeHint as libc::c_ulong).wrapping_add(ZSTDv06_blockHeaderSize);
    }
    nextSrcSizeHint = (nextSrcSizeHint as libc::c_ulong).wrapping_sub((*zbd).inPos);
    return nextSrcSizeHint;
}
#[no_mangle]
pub unsafe extern "C" fn ZBUFFv06_recommendedDInSize() -> libc::size_t {
    return (ZSTDv06_BLOCKSIZE_MAX as libc::c_ulong).wrapping_add(ZSTDv06_blockHeaderSize);
}
#[no_mangle]
pub unsafe extern "C" fn ZBUFFv06_recommendedDOutSize() -> libc::size_t {
    return ZSTDv06_BLOCKSIZE_MAX as libc::size_t;
}
