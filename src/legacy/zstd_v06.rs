...
pub const ZSTDv06_BLOCKSIZE_MAX: std::ffi::c_int = 128 as std::ffi::c_int
...
pub const FSEv06_MAX_TABLELOG: std::ffi::c_int = FSEv06_MAX_MEMORY_USAGE
    - 2 as std::ffi::c_int;
...
#[no_mangle]
pub unsafe extern "C" fn FSEv06_getErrorName(
    mut code: size_t,
...
pub unsafe extern "C" fn FSEv06_readNCount(
    ...
    nbBits = (bitStream & 0xf as std::ffi::c_int as U32)
        .wrapping_add(FSEv06_MIN_TABLELOG as U32) as std::ffi::c_int;
...
unsafe extern "C" fn FSEv06_decompress_usingDTable_generic(
        ...
        && op < olimit
    {
        *op
        ...
        if (FSEv06_MAX_TABLELOG * 2 as std::ffi::c_int + 7 as std::ffi::c_int)
            as std::ffi::c_ulong
            > (::core::mem::size_of::<size_t>() as std::ffi::c_ulong)
                .wrapping_mul(8 as std::ffi::c_int as std::ffi::c_ulong)
        {
        ...
        *op
        ...
        if (FSEv06_MAX_TABLELOG * 4 as std::ffi::c_int + 7 as std::ffi::c_int)
            as std::ffi::c_ulong
            > (::core::mem::size_of::<size_t>() as std::ffi::c_ulong)
                .wrapping_mul(8 as std::ffi::c_int as std::ffi::c_ulong)
        {
...
unsafe extern "C" fn HUFv06_decodeStreamX2(
    ...
    while BITv06_reloadDStream(bitDPtr) as std::ffi::c_uint
        == BITv06_DStream_unfinished as std::ffi::c_int as std::ffi::c_uint && p < pEnd
    {
        let fresh14 = p;
        p = p.offset(1);
...
pub unsafe extern "C" fn HUFv06_readDTableX4(
    ...
    *rankStart.offset(0 as std::ffi::c_int as isize) = 0 as std::ffi::c_int as U32;
    ...
    consumed = minBits;
    while consumed
        < memLog.wrapping_sub(minBits).wrapping_add(1 as std::ffi::c_int as U32)
    {
...
unsafe extern "C" fn HUFv06_decodeStreamX4(
        ...
        && p < pEnd.offset(-(7 as std::ffi::c_int as isize))
    {
        if MEM_64bits() != 0 {
            p = p
                .offset(
                    HUFv06_decodeSymbolX4(p as *mut std::ffi::c_void, bitDPtr, dt, dtLog)
                        as isize,
                );
        }
        if MEM_64bits() != 0 || HUFv06_MAX_TABLELOG <= 12 as std::ffi::c_int {
    ...
    if p < pEnd {
        p = p
            .offset(
                HUFv06_decodeLastSymbolX4(p as *mut std::ffi::c_void, bitDPtr, dt, dtLog)
                    as isize,
            );
    }
...
#[no_mangle]
pub unsafe extern "C" fn ZSTDv06_getErrorName(
    mut code: size_t,
) -> *const std::ffi::c_char {
    return ERR_getErrorName(code);
}
...
pub unsafe extern "C" fn ZSTDv06_sizeofDCtx() -> size_t {
    return ::core::mem::size_of::<ZSTDv06_DCtx>() as std::ffi::c_ulong;
}
#[no_mangle]
...
pub unsafe extern "C" fn ZSTDv06_createDCtx() -> *mut ZSTDv06_DCtx {
    let mut dctx = malloc(::core::mem::size_of::<ZSTDv06_DCtx>() as std::ffi::c_ulong)
        as *mut ZSTDv06_DCtx;
    if dctx.is_null() {
...
unsafe extern "C" fn ZSTDv06_frameHeaderSize(
    ...
    let fcsId = (*(src as *const BYTE).offset(4 as std::ffi::c_int as isize)
        as std::ffi::c_int >> 6 as std::ffi::c_int) as U32;
...
pub unsafe extern "C" fn ZSTDv06_getFrameParams(
    ...
    (*fparamsPtr)
        .windowLog = ((frameDesc as std::ffi::c_int & 0xf as std::ffi::c_int)
    ...
    match frameDesc as std::ffi::c_int >> 6 as std::ffi::c_int {
        ...
        1 => {
            (*fparamsPtr)
                .frameContentSize = *ip.offset(5 as std::ffi::c_int as isize)
        ...
        2 => {
            ...
            ) as std::ffi::c_int + 256 as std::ffi::c_int) as std::ffi::c_ulonglong;
            current_block_14 = 17407779659766490442;
        }
        3 => {
            (*fparamsPtr)
...
unsafe extern "C" fn ZSTDv06_decodeFrameHeader(
    ...
    if MEM_32bits() != 0
        && (*zc).fParams.windowLog > 25 as std::ffi::c_int as std::ffi::c_uint
    {
        return -(ZSTD_error_frameParameter_unsupported as std::ffi::c_int) as size_t;
    }
    return result;
...
unsafe extern "C" fn ZSTDv06_decodeSeqHeaders(
    ...
    let fresh35 = ip;
    ip = ip.offset(1);
    let mut nbSeq = *fresh35 as std::ffi::c_int;
    if nbSeq == 0 {
    ...
    *nbSeqPtr = nbSeq;
    ...
    let Offtype = (*ip as std::ffi::c_int >> 4 as std::ffi::c_int & 3 as std::ffi::c_int)
        as U32;
...
unsafe extern "C" fn ZSTDv06_decodeSequence(
    ...
    if offset < ZSTDv06_REP_NUM as size_t {
        if llCode == 0 as std::ffi::c_int as U32
    ...
    (*seq).offset = offset;
    (*seq)
        .matchLength = ((ML_base[mlCode as usize]).wrapping_add(MINMATCH as U32)
        as size_t)
        .wrapping_add(
    ...
    *litPtr = iLitEnd;
    ...
    if sequence.offset < 8 as std::ffi::c_int as size_t {
        ...
        *op
        ...
        ZSTDv06_copy8(op as *mut std::ffi::c_void, match_0 as *const std::ffi::c_void);
    }
    op = op.offset(8 as std::ffi::c_int as isize);
...
pub unsafe extern "C" fn ZBUFFv06_createDCtx() -> *mut ZBUFFv06_DCtx {
    let mut zbd = malloc(::core::mem::size_of::<ZBUFFv06_DCtx>() as std::ffi::c_ulong)
        ...
        match (*zbd).stage as std::ffi::c_uint {
            ...
            1 => {
                ...
                if hSize != 0 as std::ffi::c_int as size_t {
                    ...
                    let blockSize = (if (1 as std::ffi::c_int)
...
pub unsafe extern "C" fn ZBUFFv06_recommendedDInSize() -> size_t {
    return (ZSTDv06_BLOCKSIZE_MAX as size_t).wrapping_add(ZSTDv06_blockHeaderSize);
}
#[no_mangle]
