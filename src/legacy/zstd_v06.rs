...
static mut ZSTDv06_frameHeaderSize_min: size_t = 5 as libc::c_int as size_t;
...
pub unsafe extern "C" fn FSEv06_isError_1(mut code: size_t) -> libc::c_uint {
    return ERR_isError(code);
}
#[no_mangle]
pub unsafe extern "C" fn FSEv06_getErrorName(mut code: size_t) -> *const libc::c_char {
    return ERR_getErrorName(code);
}
unsafe extern "C" fn HUFv06_isError(mut code: size_t) -> libc::c_uint {
    return ERR_isError(code);
}
...
pub const FSEv06_isError_0: unsafe extern "C" fn(size_t) -> libc::c_uint = ERR_isError;
#[no_mangle]
...
pub unsafe extern "C" fn FSEv06_buildDTable(
    ...
    while u < tableSize {
        ...
        (*tableDecode.offset(u as isize))
            .nbBits = tableLog.wrapping_sub(BITv06_highbit32(nextState as U32)) as BYTE;
        (*tableDecode.offset(u as isize))
...
pub unsafe extern "C" fn HUFv06_readDTableX2(
    ...
    iSize = HUFv06_readStats(
        ...
        (HUFv06_MAX_SYMBOL_VALUE + 1 as libc::c_int) as size_t,
        rankVal.as_mut_ptr(),
        &mut nbSymbols,
        &mut tableLog,
        src,
...
pub unsafe extern "C" fn HUFv06_readDTableX4(
    ...
    *rankStart.offset(0 as libc::c_int as isize) = 0 as libc::c_int as U32;
    ...
    consumed = minBits;
    while consumed
        < memLog.wrapping_sub(minBits).wrapping_add(1 as libc::c_int as libc::c_uint)
    {
...
pub unsafe extern "C" fn ZSTDv06_isError_0(mut code: size_t) -> libc::c_uint {
    return ERR_isError(code);
}
#[no_mangle]
pub unsafe extern "C" fn ZSTDv06_getErrorName(mut code: size_t) -> *const libc::c_char {
    return ERR_getErrorName(code);
}
#[no_mangle]
pub unsafe extern "C" fn ZBUFFv06_isError(mut errorCode: size_t) -> libc::c_uint {
...
pub const ZSTDv06_isError: unsafe extern "C" fn(size_t) -> libc::c_uint = ERR_isError;
pub const FSEv06_isError: unsafe extern "C" fn(size_t) -> libc::c_uint = ERR_isError;
pub const HUFv06_isError_0: unsafe extern "C" fn(size_t) -> libc::c_uint = ERR_isError;
...
unsafe extern "C" fn ZSTDv06_frameHeaderSize(
    ...
    let fcsId = (*(src as *const BYTE).offset(4 as libc::c_int as isize) as libc::c_int
        >> 6 as libc::c_int) as U32;
...
unsafe extern "C" fn ZSTDv06_decodeSequence(
    ...
    if offset < ZSTDv06_REP_NUM as libc::c_ulong {
        ...
        offset = (offset as libc::c_ulong)
            .wrapping_sub(ZSTDv06_REP_MOVE as libc::c_ulong) as size_t as size_t;
        (*seqState)
            .prevOffset[2 as libc::c_int
            as usize] = (*seqState).prevOffset[1 as libc::c_int as usize];
        (*seqState)
...
unsafe extern "C" fn ZSTDv06_decompressSequences(
    ...
    if nbSeq != 0 {
        ...
        while i < ZSTDv06_REP_INIT as libc::c_uint {
            seqState.prevOffset[i as usize] = REPCODE_STARTVALUE as size_t;
            i = i.wrapping_add(1);
        }
        let errorCode = BITv06_initDStream(
...
unsafe extern "C" fn ZSTDv06_decompressFrame(
    ...
    loop {
        ...
        remainingSize = (remainingSize as libc::c_ulong)
            .wrapping_sub(ZSTDv06_blockHeaderSize) as size_t as size_t;
    ...
    *dstCapacityPtr = op.offset_from(ostart) as libc::c_long as size_t;
    ...
    if nextSrcSizeHint > ZSTDv06_blockHeaderSize {
        nextSrcSizeHint = (nextSrcSizeHint as libc::c_ulong)
            .wrapping_add(ZSTDv06_blockHeaderSize) as size_t as size_t;
    }
...
pub unsafe extern "C" fn ZBUFFv06_recommendedDOutSize() -> size_t {
    return ZSTDv06_BLOCKSIZE_MAX as size_t;
}
