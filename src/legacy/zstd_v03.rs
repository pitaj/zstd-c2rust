    ...
    if srcSize >= ::core::mem::size_of::<size_t>() as std::ffi::c_ulong {
        ...
        match srcSize {
            7 => {
                ...
                current_block_21 = 16060096534408587340;
            }
            6 => {
                current_block_21 = 16060096534408587340;
            }
            5 => {
                current_block_21 = 6951009688330324617;
            }
            4 => {
                current_block_21 = 8144426327167202880;
            }
            3 => {
                current_block_21 = 17479074191869839677;
            }
            2 => {
                current_block_21 = 7179728134253626143;
            }
            _ => {
...
pub const ZSTD_magicNumber: std::ffi::c_uint = 0xfd2fb523 as std::ffi::c_uint;
...
unsafe extern "C" fn FSE_buildDTable(
    ...
    let mut ptr = dt.offset(1 as std::ffi::c_int as isize) as *mut std::ffi::c_void;
    let mut DTableH = FSE_DTableHeader {
        tableLog: 0,
        fastMode: 0,
    };
...
unsafe extern "C" fn HUF_readDTableX2(
    ...
    let mut ip = src as *const BYTE;
    let mut iSize = *ip.offset(0 as std::ffi::c_int as isize) as size_t;
...
unsafe extern "C" fn HUF_decompress4X2_usingDTable(
    ...
    let dt = (ptr as *const HUF_DEltX2).offset(1 as std::ffi::c_int as isize);
...
unsafe extern "C" fn HUF_readDTableX4(
    ...
    let mut ip = src as *const BYTE;
    let mut iSize = *ip.offset(0 as std::ffi::c_int as isize) as size_t;
    let mut ptr = DTable as *mut std::ffi::c_void;
    let dt = (ptr as *mut HUF_DEltX4).offset(1 as std::ffi::c_int as isize);
...
unsafe extern "C" fn HUF_decompress4X4_usingDTable(
    ...
    let oend = ostart.offset(dstSize as isize);
    let mut ptr = DTable as *const std::ffi::c_void;
    let dt = (ptr as *const HUF_DEltX4).offset(1 as std::ffi::c_int as isize);
...
unsafe extern "C" fn ZSTD_decodeSequence(
    ...
    static mut offsetPrefix: [size_t; 32] = [
        ...
        32 as std::ffi::c_int as size_t,
        64 as std::ffi::c_int as size_t,
        128 as std::ffi::c_int as size_t,
        256 as std::ffi::c_int as size_t,
        512 as std::ffi::c_int as size_t,
        1024 as std::ffi::c_int as size_t,
        2048 as std::ffi::c_int as size_t,
        4096 as std::ffi::c_int as size_t,
        8192 as std::ffi::c_int as size_t,
        16384 as std::ffi::c_int as size_t,
        32768 as std::ffi::c_int as size_t,
        65536 as std::ffi::c_int as size_t,
        131072 as std::ffi::c_int as size_t,
        262144 as std::ffi::c_int as size_t,
        524288 as std::ffi::c_int as size_t,
        1048576 as std::ffi::c_int as size_t,
        2097152 as std::ffi::c_int as size_t,
        4194304 as std::ffi::c_int as size_t,
        8388608 as std::ffi::c_int as size_t,
        16777216 as std::ffi::c_int as size_t,
        33554432 as std::ffi::c_int as size_t,
        1 as std::ffi::c_int as size_t,
        1 as std::ffi::c_int as size_t,
        1 as std::ffi::c_int as size_t,
        1 as std::ffi::c_int as size_t,
...
unsafe extern "C" fn ZSTD_execSequence(
    ...
    *litPtr = litEnd;
    ...
    return oMatchEnd.offset_from(ostart) as std::ffi::c_long as size_t;
}
unsafe extern "C" fn ZSTD_decompressSequences(
    ...
    while BIT_reloadDStream(&mut seqState.DStream) as std::ffi::c_uint
        <= BIT_DStream_completed as std::ffi::c_int as std::ffi::c_uint
...
unsafe extern "C" fn ZSTD_decompress(
    ...
    return ZSTD_decompressDCtx(
        &mut ctx as *mut ZSTD_DCtx as *mut std::ffi::c_void,
        dst,
        maxDstSize,
        src,
        srcSize,
...
#[no_mangle]
pub unsafe extern "C" fn ZSTDv03_isError(mut code: size_t) -> std::ffi::c_uint {
