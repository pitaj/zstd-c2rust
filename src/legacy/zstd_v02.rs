...
unsafe extern "C" fn HUF_readDTableX6(
    ...
    *rankStart.offset(0 as libc::c_int as isize) = 0 as libc::c_int as U32;
    ...
    let mut dSeqStart = DTable
        ...
        .offset(
            ((1 as libc::c_int as size_t)
                << memLog.wrapping_sub(1 as libc::c_int as libc::c_uint)) as isize,
        ) as *mut libc::c_void;
    ...
    DDesc.nbBits = 0 as libc::c_int as BYTE;
    DDesc.nbBytes = 0 as libc::c_int as BYTE;
    HUF_fillDTableX6LevelN(
        DDescription,
        DSequence,
...
unsafe extern "C" fn HUF_decodeStreamX6(
    ...
    let mut dsPtr = DTable
        ...
        .offset(
            ((1 as libc::c_int as size_t)
                << dtLog.wrapping_sub(1 as libc::c_int as libc::c_uint)) as isize,
...
#[no_mangle]
pub unsafe extern "C" fn ZSTDv02_isError(mut code: size_t) -> libc::c_uint {
