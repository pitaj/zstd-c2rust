...
#[inline]
pub const fn ZSTD_countTrailingZeros32(val: u32) -> u32 {
    val.trailing_zeros()
}
#[inline]
pub const fn ZSTD_countLeadingZeros32(val: u32) -> u32 {
    val.leading_zeros()
}

#[inline]
pub const fn ZSTD_countTrailingZeros64(val: u64) -> u32 {
    val.trailing_zeros()
}
#[inline]
pub const fn ZSTD_countLeadingZeros64(val: u64) -> u32 {
    val.leading_zeros()
}

#[inline]
pub const fn ZSTD_NbCommonBytes(val: usize) -> u32 {
...
#[inline]
pub const fn ZSTD_highbit32(val: u32) -> u32 {
    debug_assert!(val != 0);
