...
pub unsafe extern "C" fn ERR_getErrorString(mut code: ERR_enum) -> *const libc::c_char {
    ...
    match code as libc::c_uint {
        ...
        10 => return b"Unknown frame descriptor\0" as *const u8 as *const libc::c_char,
        12 => return b"Version not supported\0" as *const u8 as *const libc::c_char,
        14 => return b"Unsupported frame parameter\0" as *const u8 as *const libc::c_char,
        16 => {
        ...
        30 => return b"Dictionary is corrupted\0" as *const u8 as *const libc::c_char,
        32 => return b"Dictionary mismatch\0" as *const u8 as *const libc::c_char,
        34 => {
        ...
        100 => return b"Frame index is too large\0" as *const u8 as *const libc::c_char,
        102 => {
            return b"An I/O error occurred when reading/seeking\0" as *const u8
                as *const libc::c_char;
        }
        104 => {
            return b"Destination buffer is wrong\0" as *const u8 as *const libc::c_char;
        }
