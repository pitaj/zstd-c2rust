...
#[no_mangle]
pub unsafe extern "C" fn ERR_getErrorString(
    mut code: ERR_enum,
) -> *const std::ffi::c_char {
    static mut notErrorCode: *const std::ffi::c_char = b"Unspecified error code\0"
    ...
    match code as std::ffi::c_uint {
        ...
        14 => {
            return b"Unsupported frame parameter\0" as *const u8
        ...
        62 => {
            return b"Context should be init first\0" as *const u8
                as *const std::ffi::c_char;
        }
        64 => {
        ...
        104 => {
            return b"Destination buffer is wrong\0" as *const u8
                as *const std::ffi::c_char;
        }
