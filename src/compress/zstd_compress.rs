...
unsafe fn ZSTD_indexTooCloseToMax(mut w: ZSTD_window_t) -> std::ffi::c_int {
...
unsafe fn ZSTD_dictTooBig(loadedDictSize: usize) -> std::ffi::c_int {
...
unsafe fn ZSTD_maybeRLE(mut seqStore: *const SeqStore_t) -> std::ffi::c_int {
