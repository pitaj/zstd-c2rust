...
pub const ZSTD_LITFREQ_ADD: std::ffi::c_int = 2;
pub const ZSTD_MAX_PRICE: std::ffi::c_int = (1 as std::ffi::c_int)
    << 30;
pub const ZSTD_PREDEF_THRESHOLD: std::ffi::c_int = 8;
pub const BITCOST_ACCURACY: std::ffi::c_int = 8;
