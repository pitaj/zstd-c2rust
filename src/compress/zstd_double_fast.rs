...
unsafe extern "C" fn ZSTD_compressBlock_doubleFast_dictMatchState_generic(
    ...
    if (*ms).prefetchCDictTables != 0 {
        ...
        let chainTableBytes = ((1 as std::ffi::c_int as size_t)
        ...
        *fresh3 = PREFETCH_AREA!(dictHashLong, hashTableBytes);
        while PREFETCH_AREA!(dictHashLong, hashTableBytes) != 0 {
            ...
            *fresh4 = (*fresh4).wrapping_add(CACHELINE_SIZE as size_t);
        }
        ...
        *fresh5 = PREFETCH_AREA!(dictHashSmall, chainTableBytes);
        while PREFETCH_AREA!(dictHashSmall, chainTableBytes) != 0 {
            ...
            *fresh6 = (*fresh6).wrapping_add(CACHELINE_SIZE as size_t);
        }
    }
    ip = ip
        .offset(
