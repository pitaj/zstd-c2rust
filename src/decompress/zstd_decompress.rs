...
extern "C" {
    ...
    fn ZSTD_getDictID_fromDDict(ddict: *const ZSTD_DDict) -> u32;
    ...
    fn ZSTDv05_freeDCtx(dctx: *mut ZSTDv05_DCtx) -> usize;
    ...
    fn ZBUFFv05_freeDCtx(dctx: *mut ZBUFFv05_DCtx) -> usize;
    ...
    fn ZSTDv06_freeDCtx(dctx: *mut ZSTDv06_DCtx) -> usize;
    ...
    fn ZBUFFv06_freeDCtx(dctx: *mut ZBUFFv06_DCtx) -> usize;
    ...
    fn ZSTDv07_freeDCtx(dctx: *mut ZSTDv07_DCtx) -> usize;
    ...
    fn ZBUFFv07_freeDCtx(dctx: *mut ZBUFFv07_DCtx) -> usize;
...
pub type streaming_operation = u32;
...
pub const ZSTD_MAXWINDOWSIZE_DEFAULT: u32 = (1_u32
    ...
    .wrapping_add(1);
pub const ZSTD_NO_FORWARD_PROGRESS_MAX: i32 = 16;
pub const ZSTD_VERSION_MAJOR: i32 = 1;
pub const ZSTD_VERSION_MINOR: i32 = 5;
pub const ZSTD_VERSION_RELEASE: i32 = 8;
pub const ZSTD_VERSION_NUMBER: i32 = ZSTD_VERSION_MAJOR
    * 100 as i32 * 100 as i32
    + ZSTD_VERSION_MINOR * 100 as i32 + ZSTD_VERSION_RELEASE;
pub const ZSTD_MAGICNUMBER: u32 = 0xfd2fb528 as u32;
pub const ZSTD_MAGIC_DICTIONARY: u32 = 0xec30a437 as u32;
pub const ZSTD_MAGIC_SKIPPABLE_START: i32 = 0x184d2a50 as i32;
pub const ZSTD_MAGIC_SKIPPABLE_MASK: u32 = 0xfffffff0 as u32;
...
pub const ZSTD_d_format: i32 = 1000;
pub const ZSTD_d_stableOutBuffer: i32 = 1001;
pub const ZSTD_d_forceIgnoreChecksum: i32 = 1002;
pub const ZSTD_d_refMultipleDDicts: i32 = 1003;
pub const ZSTD_d_disableHuffmanAssembly: i32 = 1004;
pub const ZSTD_d_maxBlockSize: i32 = 1005;
...
static mut OF_base: [u32; 32] = [
    ...
    0x7fd as i32 as u32,
    0xffd as i32 as u32,
    0x1ffd as i32 as u32,
    0x3ffd as i32 as u32,
    0x7ffd as i32 as u32,
    0xfffd as i32 as u32,
    0x1fffd as i32 as u32,
    0x3fffd as i32 as u32,
    0x7fffd as i32 as u32,
    0xffffd as i32 as u32,
    0x1ffffd as i32 as u32,
    0x3ffffd as i32 as u32,
    0x7ffffd as i32 as u32,
    0xfffffd as i32 as u32,
    0x1fffffd as i32 as u32,
    0x3fffffd as i32 as u32,
    0x7fffffd as i32 as u32,
    0xffffffd as i32 as u32,
    0x1ffffffd as i32 as u32,
    0x3ffffffd as i32 as u32,
    0x7ffffffd as i32 as u32,
];
...
static mut ML_base: [u32; 53] = [
    ...
    0x403 as i32 as u32,
    0x803 as i32 as u32,
    0x1003 as i32 as u32,
    0x2003 as i32 as u32,
    0x4003 as i32 as u32,
    0x8003 as i32 as u32,
    0x10003 as i32 as u32,
];
...
static mut ZSTD_fcs_fieldSize: [usize; 4] = [
    0,
    2,
    4,
    8,
];
static mut ZSTD_did_fieldSize: [usize; 4] = [
    0,
    1,
    2,
    4,
...
pub const MaxML: i32 = 52;
pub const MaxLL: i32 = 35;
pub const MaxOff: i32 = 31;
...
pub const WILDCOPY_OVERLENGTH: i32 = 32;
#[inline]
...
pub const ZSTD_WORKSPACETOOLARGE_FACTOR: i32 = 3;
pub const ZSTD_WORKSPACETOOLARGE_MAXDURATION: i32 = 128;
#[inline]
unsafe extern "C" fn ZSTD_cpuSupportsBmi2() -> i32 {
...
unsafe extern "C" fn ZSTD_cpuid() -> ZSTD_cpuid_t {
    ...
    let mut n: u32 = 0;
    asm!(
        "cpuid", inlateout("ax") 0 as i32 => n, out("ecx") _, out("edx") _,
        options(preserves_flags, pure, readonly, att_syntax)
    );
    if n >= 1 {
        let mut f1a: u32 = 0;
        asm!(
            "cpuid", inlateout("ax") 1 as i32 => f1a, lateout("cx") f1c,
    ...
    if n >= 7 {
        ...
        asm!(
            ...
            as i32 => f7a, inlateout("cx") 0 as i32 => f7c,
...
#[inline]
unsafe extern "C" fn ZSTD_cpuid_bmi1(cpuid: ZSTD_cpuid_t) -> i32 {
    return B!(bmi1, 3);
}
#[inline]
unsafe extern "C" fn ZSTD_cpuid_bmi2(cpuid: ZSTD_cpuid_t) -> i32 {
    return B!(bmi2, 8);
}
use crate::common::bits::*;
pub const ZSTDv05_MAGICNUMBER: u32 = 4247762213;
pub const ZSTDv06_MAGICNUMBER: u32 = 4247762214;
pub const ZSTDv07_MAGICNUMBER: u32 = 4247762215;
#[inline]
unsafe extern "C" fn ZSTD_isLegacy(
    ...
    match magicNumberLE {
        ZSTDv05_MAGICNUMBER => return 5,
        ZSTDv06_MAGICNUMBER => return 6,
        ZSTDv07_MAGICNUMBER => return 7,
        _ => return 0,
    };
}
#[inline]
...
unsafe extern "C" fn ZSTD_decompressLegacy(
    ...
    if src.is_null() {
        src = &mut x as *mut c_char as *const c_void;
    }
    if dict.is_null() {
        dict = &mut x as *mut c_char as *const c_void;
    }
    match version {
        5 => {
            let mut result: usize = 0;
            let zd = ZSTDv05_createDCtx();
            RETURN_ERROR_IF!(zd.is_null(), ZSTD_error_memory_allocation);
        ...
        6 => {
            ...
            RETURN_ERROR_IF!(zd_0.is_null(), ZSTD_error_memory_allocation);
        ...
        7 => {
            ...
            RETURN_ERROR_IF!(zd_1.is_null(), ZSTD_error_memory_allocation);
...
unsafe extern "C" fn ZSTD_findFrameSizeInfoLegacy(
    ...
    if frameSizeInfo.decompressedBound != ZSTD_CONTENTSIZE_ERROR {
        frameSizeInfo
            ...
            .wrapping_div(ZSTD_BLOCKSIZE_MAX as u64) as usize;
    }
...
unsafe extern "C" fn ZSTD_initLegacyStream(
    mut legacyContext: *mut *mut c_void,
    mut prevVersion: u32,
    mut newVersion: u32,
    mut dict: *const c_void,
    mut dictSize: usize,
    ...
    match newVersion {
        5 => {
            ...
            RETURN_ERROR_IF!(dctx.is_null(), ZSTD_error_memory_allocation);
        ...
        6 => {
            ...
            RETURN_ERROR_IF!(dctx_0.is_null(), ZSTD_error_memory_allocation);
            ZBUFFv06_decompressInitDictionary(dctx_0, dict, dictSize);
            *legacyContext = dctx_0 as *mut c_void;
            return 0;
        }
        7 => {
            ...
            RETURN_ERROR_IF!(dctx_1.is_null(), ZSTD_error_memory_allocation);
            ZBUFFv07_decompressInitDictionary(dctx_1, dict, dictSize);
            *legacyContext = dctx_1 as *mut c_void;
            return 0;
        }
        1 | 2 | 3 | _ => return 0,
    };
...
unsafe extern "C" fn ZSTD_decompressLegacyStream(
    ...
    if ((*output).dst).is_null() {
        (*output).dst = &mut x as *mut c_char as *mut c_void;
    }
    if ((*input).src).is_null() {
        (*input).src = &mut x as *mut c_char as *const c_void;
    }
    match version {
        5 => {
            let mut dctx = legacyContext as *mut ZBUFFv05_DCtx;
            let mut src = ((*input).src as *const c_char)
                .offset((*input).pos as isize) as *const c_void;
            let mut readSize = ((*input).size).wrapping_sub((*input).pos);
            let mut dst = ((*output).dst as *mut c_char)
                .offset((*output).pos as isize) as *mut c_void;
        ...
        6 => {
            ...
            let mut src_0 = ((*input).src as *const c_char)
                .offset((*input).pos as isize) as *const c_void;
            let mut readSize_0 = ((*input).size).wrapping_sub((*input).pos);
            let mut dst_0 = ((*output).dst as *mut c_char)
                .offset((*output).pos as isize) as *mut c_void;
        ...
        7 => {
            ...
            let mut src_1 = ((*input).src as *const c_char)
                .offset((*input).pos as isize) as *const c_void;
            let mut readSize_1 = ((*input).size).wrapping_sub((*input).pos);
            let mut dst_1 = ((*output).dst as *mut c_char)
                .offset((*output).pos as isize) as *mut c_void;
...
pub const DDICT_HASHSET_MAX_LOAD_FACTOR_COUNT_MULT: i32 = 4
    as i32;
pub const DDICT_HASHSET_MAX_LOAD_FACTOR_SIZE_MULT: i32 = 3
    as i32;
pub const DDICT_HASHSET_TABLE_BASE_SIZE: i32 = 64;
pub const DDICT_HASHSET_RESIZE_FACTOR: i32 = 2;
unsafe extern "C" fn ZSTD_DDictHashSet_getIndex(
    mut hashSet: *const ZSTD_DDictHashSet,
    mut dictID: u32,
) -> usize {
    let hash = ZSTD_XXH64(
        &mut dictID as *mut u32 as *const c_void,
        ::core::mem::size_of::<u32>(),
        0,
    );
    return hash
        & ((*hashSet).ddictPtrTableSize).wrapping_sub(1);
}
unsafe extern "C" fn ZSTD_DDictHashSet_emplaceDDict(
    ...
    let idxRangeMask = ((*hashSet).ddictPtrTableSize)
        .wrapping_sub(1);
    RETURN_ERROR_IF!((*hashSet).ddictPtrCount == (*hashSet).ddictPtrTableSize, ZSTD_error_GENERIC);
...
unsafe extern "C" fn ZSTD_DDictHashSet_expand(
    ...
    let mut newTableSize = (*hashSet).ddictPtrTableSize
        * DDICT_HASHSET_RESIZE_FACTOR as usize;
    let mut newTable = ZSTD_customCalloc(
        (::core::mem::size_of::<*mut ZSTD_DDict>())
    ...
    let mut i: usize = 0;
    RETURN_ERROR_IF!(newTable.is_null(), ZSTD_error_memory_allocation);
...
#[no_mangle]
pub unsafe extern "C" fn ZSTD_sizeof_DCtx(mut dctx: *const ZSTD_DCtx) -> usize {
    if dctx.is_null() {
        return 0;
    }
...
pub unsafe extern "C" fn ZSTD_initStaticDCtx(
    ...
    (*dctx).inBuff = dctx.offset(1) as *mut c_char;
    return dctx;
}
...
#[no_mangle]
pub unsafe extern "C" fn ZSTD_freeDCtx(mut dctx: *mut ZSTD_DCtx) -> usize {
    if dctx.is_null() {
        return 0;
    }
    RETURN_ERROR_IF!((*dctx).staticSize != 0, ZSTD_error_memory_allocation);
...
pub unsafe extern "C" fn ZSTD_copyDCtx(
    ...
    let toCopy = (&mut (*dstDCtx).inBuff as *mut *mut c_char
        as *mut c_char)
        .offset_from(dstDCtx as *mut c_char) as std::ffi::c_long as usize;
...
pub unsafe extern "C" fn ZSTD_isFrame(
    mut buffer: *const c_void,
    mut size: usize,
) -> u32 {
    if size < ZSTD_FRAMEIDSIZE as usize {
        return 0;
    }
...
unsafe extern "C" fn ZSTD_frameHeaderSize_internal(
    ...
    RETURN_ERROR_IF!(srcSize < minInputSize, ZSTD_error_srcSize_wrong);
    let fhd = *(src as *const u8)
        .offset(minInputSize.wrapping_sub(1) as isize);
    let dictID = (fhd as i32 & 3 as i32) as u32;
    let singleSegment = (fhd as i32 >> 5
        & 1 as i32) as u32;
    let fcsId = (fhd as i32 >> 6) as u32;
    return minInputSize
        .wrapping_add((singleSegment == 0) as i32 as usize)
        .wrapping_add(ZSTD_did_fieldSize[dictID as usize])
        .wrapping_add(ZSTD_fcs_fieldSize[fcsId as usize])
        .wrapping_add((singleSegment != 0 && fcsId == 0) as i32 as usize);
}
#[no_mangle]
...
pub unsafe extern "C" fn ZSTD_getFrameHeader_advanced(
    ...
    let minInputSize = ZSTD_startingInputLength(format);
    if srcSize > 0 {
        RETURN_ERROR_IF!(src.is_null(), ZSTD_error_GENERIC);
    }
    if srcSize < minInputSize {
        if srcSize > 0
            && format as u32
                != ZSTD_f_zstd1_magicless as i32 as u32
        {
            ...
            if MEM_readLE32(hbuf.as_mut_ptr() as *const c_void)
                != ZSTD_MAGICNUMBER
            {
                MEM_writeLE32(
                    hbuf.as_mut_ptr() as *mut c_void,
                    ZSTD_MAGIC_SKIPPABLE_START as u32,
                );
                libc::memcpy(hbuf, src, (toCopy) as usize);
                RETURN_ERROR_IF!(MEM_readLE32(hbuf.as_mut_ptr() as *const c_void)
                    & ZSTD_MAGIC_SKIPPABLE_MASK
                    != ZSTD_MAGIC_SKIPPABLE_START as u32, ZSTD_error_prefix_unknown);
            }
        }
        return minInputSize;
    }
    libc::memset(
        ...
        0,
        ::core::mem::size_of::<ZSTD_FrameHeader>() as usize,
    );
    if format as u32
        != ZSTD_f_zstd1_magicless as i32 as u32
        && MEM_readLE32(src) != ZSTD_MAGICNUMBER
    {
        if MEM_readLE32(src) & ZSTD_MAGIC_SKIPPABLE_MASK
            == ZSTD_MAGIC_SKIPPABLE_START as u32
        {
            if srcSize < ZSTD_SKIPPABLEHEADERSIZE as usize {
                return ZSTD_SKIPPABLEHEADERSIZE as usize;
            }
            libc::memset(
                zfhPtr as *mut c_void,
                0,
            ...
            (*zfhPtr)
                .dictID = (MEM_readLE32(src))
                .wrapping_sub(ZSTD_MAGIC_SKIPPABLE_START as u32);
            (*zfhPtr).headerSize = ZSTD_SKIPPABLEHEADERSIZE as u32;
            (*zfhPtr)
                .frameContentSize = MEM_readLE32(
                (src as *const c_char).offset(ZSTD_FRAMEIDSIZE as isize)
                    as *const c_void,
            ) as u64;
            return 0;
        }
    ...
    let dictIDSizeCode = (fhdByte as i32 & 3 as i32) as u32;
    let checksumFlag = (fhdByte as i32 >> 2
        & 1 as i32) as u32;
    let singleSegment = (fhdByte as i32 >> 5
        & 1 as i32) as u32;
    let fcsID = (fhdByte as i32 >> 6) as u32;
    let mut windowSize: u64 = 0;
    let mut dictID: u32 = 0;
    let mut frameContentSize = ZSTD_CONTENTSIZE_UNKNOWN as u64;
    RETURN_ERROR_IF!(fhdByte as i32 & 0x8 as i32 != 0, ZSTD_error_frameParameter_unsupported);
    if singleSegment == 0 {
        let fresh2 = pos;
        pos = pos.wrapping_add(1);
        let wlByte = *ip.offset(fresh2 as isize);
        let windowLog = ((wlByte as i32 >> 3)
        ...
        {
            return -(ZSTD_error_frameParameter_windowTooLarge as i32)
                as usize;
        }
        windowSize = ((1 as u64) << windowLog) as u64;
        windowSize = windowSize
            .wrapping_add(
                (windowSize >> 3)
                    * (wlByte as i32 & 7 as i32) as u64,
            );
    }
    match dictIDSizeCode {
        ...
        2 => {
            dictID = MEM_readLE16(ip.offset(pos as isize) as *const c_void)
                as u32;
            pos = pos.wrapping_add(2);
        }
        3 => {
            dictID = MEM_readLE32(ip.offset(pos as isize) as *const c_void);
    ...
    match fcsID {
        1 => {
            frameContentSize = (MEM_readLE16(
                ip.offset(pos as isize) as *const c_void,
            ) as i32 + 256 as i32) as u64;
        }
        2 => {
            frameContentSize = MEM_readLE32(
                ip.offset(pos as isize) as *const c_void,
    ...
    (*zfhPtr).frameContentSize = frameContentSize as u64;
    (*zfhPtr).windowSize = windowSize as u64;
    (*zfhPtr).blockSizeMax = std::cmp::min(windowSize, ZSTD_BLOCKSIZE_MAX) as u32;
...
pub unsafe extern "C" fn ZSTD_getFrameContentSize(
    ...
    if zfh.frameType as u32
        == ZSTD_skippableFrame as i32 as u32
    {
        return 0 as u64
    } else {
...
unsafe extern "C" fn readSkippableFrameSize(
    ...
    RETURN_ERROR_IF!(srcSize < 8, ZSTD_error_srcSize_wrong);
    sizeU32 = MEM_readLE32(
        (src as *const u8).offset(ZSTD_FRAMEIDSIZE as isize) as *const c_void,
    );
    RETURN_ERROR_IF!(sizeU32.wrapping_add(8) < sizeU32, ZSTD_error_frameParameter_unsupported);
    let skippableSize = skippableHeaderSize.wrapping_add(sizeU32 as usize);
    RETURN_ERROR_IF!(skippableSize > srcSize, ZSTD_error_srcSize_wrong);
...
pub unsafe extern "C" fn ZSTD_readSkippableFrame(
    ...
    let mut skippableContentSize = skippableFrameSize
        .wrapping_sub(ZSTD_SKIPPABLEHEADERSIZE as usize);
    RETURN_ERROR_IF!(ZSTD_isSkippableFrame(src, srcSize) == 0, ZSTD_error_frameParameter_unsupported);
    RETURN_ERROR_IF!(skippableFrameSize < 8
        || skippableFrameSize > srcSize, ZSTD_error_srcSize_wrong);
    RETURN_ERROR_IF!(skippableContentSize > dstCapacity, ZSTD_error_dstSize_tooSmall);
...
pub unsafe extern "C" fn ZSTD_findDecompressedSize(
    ...
    while srcSize >= ZSTD_startingInputLength(ZSTD_f_zstd1) {
            ...
            == ZSTD_MAGIC_SKIPPABLE_START as u32
        {
            ...
            src = (src as *const u8).offset(frameSrcSize as isize)
                as *const c_void;
...
unsafe extern "C" fn ZSTD_decodeFrameHeader(
    ...
    RETURN_ERROR_IF!(result > 0, ZSTD_error_srcSize_wrong);
    if (*dctx).refMultipleDDicts as u32
        == ZSTD_rmd_refMultipleDDicts as i32 as u32
        && !((*dctx).ddictSet).is_null()
    {
        ZSTD_DCtx_selectFrameDDict(dctx);
    }
    RETURN_ERROR_IF!((*dctx).fParams.dictID != 0 && (*dctx).dictID != (*dctx).fParams.dictID, ZSTD_error_dictionary_wrong);
    (*dctx)
...
unsafe extern "C" fn ZSTD_errorFrameSizeInfo(mut ret: usize) -> ZSTD_frameSizeInfo {
    let mut frameSizeInfo = ZSTD_frameSizeInfo {
        nbBlocks: 0,
        compressedSize: 0,
        decompressedBound: 0,
...
unsafe extern "C" fn ZSTD_findFrameSizeInfo(
    ...
    libc::memset(
        ...
        0,
        ::core::mem::size_of::<ZSTD_frameSizeInfo>() as usize,
    );
    if format as u32 == ZSTD_f_zstd1 as i32 as u32
        && ZSTD_isLegacy(src, srcSize) != 0
    {
        return ZSTD_findFrameSizeInfoLegacy(src, srcSize);
    }
    if format as u32 == ZSTD_f_zstd1 as i32 as u32
        && srcSize >= ZSTD_SKIPPABLEHEADERSIZE as usize
            ...
            == ZSTD_MAGIC_SKIPPABLE_START as u32
    {
        ...
        loop {
            ...
            remainingSize = remainingSize
                .wrapping_sub(ZSTD_blockHeaderSize.wrapping_add(cBlockSize));
        ...
        frameSizeInfo
            .compressedSize = ip.offset_from(ipstart) as std::ffi::c_long as usize;
        frameSizeInfo
            .decompressedBound = if zfh.frameContentSize != ZSTD_CONTENTSIZE_UNKNOWN {
            zfh.frameContentSize
        } else {
            (nbBlocks as u64)
                .wrapping_mul(zfh.blockSizeMax as u64)
        };
        return frameSizeInfo;
    };
}
...
pub unsafe extern "C" fn ZSTD_decompressBound(
    ...
    while srcSize > 0 {
        ...
        if ERR_isError(compressedSize)
            || decompressedBound == ZSTD_CONTENTSIZE_ERROR
        {
            return ZSTD_CONTENTSIZE_ERROR;
        }
        src = (src as *const u8).offset(compressedSize as isize)
            as *const c_void;
...
pub unsafe extern "C" fn ZSTD_decompressionMargin(
    ...
    while srcSize > 0 {
        ...
        RETURN_ERROR_IF!(ERR_isError(compressedSize)
            || decompressedBound == ZSTD_CONTENTSIZE_ERROR, ZSTD_error_corruption_detected);
        if zfh.frameType as u32
            == ZSTD_frame as i32 as u32
        {
...
pub unsafe extern "C" fn ZSTD_insertBlock(
    ...
    (*dctx)
        .previousDstEnd = (blockStart as *const c_char)
        .offset(blockSize as isize) as *const c_void;
    return blockSize;
}
unsafe extern "C" fn ZSTD_copyRawBlock(
    ...
    RETURN_ERROR_IF!(srcSize > dstCapacity, ZSTD_error_dstSize_tooSmall);
    if dst.is_null() {
        if srcSize == 0 {
            return 0;
        }
...
unsafe extern "C" fn ZSTD_setRleBlock(
    ...
    RETURN_ERROR_IF!(regenSize > dstCapacity, ZSTD_error_dstSize_tooSmall);
    if dst.is_null() {
        if regenSize == 0 {
            return 0;
        }
...
unsafe extern "C" fn ZSTD_decompressFrame(
    ...
    mut dst: *mut c_void,
    mut dstCapacity: usize,
    mut srcPtr: *mut *const c_void,
    mut srcSizePtr: *mut usize,
) -> usize {
    ...
    RETURN_ERROR_IF!(remainingSrcSize < frameHeaderSize.wrapping_add(ZSTD_blockHeaderSize), ZSTD_error_srcSize_wrong);
    FORWARD_IF_ERROR!(
    ...
    loop {
        ...
        RETURN_ERROR_IF!(cBlockSize > remainingSrcSize, ZSTD_error_srcSize_wrong);
        if ip >= op as *const u8 && ip < oBlockEnd as *const u8 {
            oBlockEnd = op.offset(ip.offset_from(op) as std::ffi::c_long as isize);
        }
        match blockProperties.blockType as u32 {
            2 => {
                decodedSize = ZSTD_decompressBlock_internal(
                    dctx,
                    op as *mut c_void,
                    oBlockEnd.offset_from(op) as std::ffi::c_long as usize,
                    ip as *const c_void,
                    cBlockSize,
                    not_streaming,
                );
    ...
    if (*dctx).fParams.frameContentSize != ZSTD_CONTENTSIZE_UNKNOWN {
        RETURN_ERROR_IF!(op.offset_from(ostart) as std::ffi::c_long as u64 as u64
            != (*dctx).fParams.frameContentSize, ZSTD_error_corruption_detected);
    }
    if (*dctx).fParams.checksumFlag != 0 {
        RETURN_ERROR_IF!(remainingSrcSize < 4, ZSTD_error_checksum_wrong);
        if (*dctx).forceIgnoreChecksum as u64 == 0 {
            ...
            RETURN_ERROR_IF!(checkRead != checkCalc, ZSTD_error_checksum_wrong);
        }
        ip = ip.offset(4);
...
unsafe extern "C" fn ZSTD_decompressMultiFrame(
    ...
    while srcSize >= ZSTD_startingInputLength((*dctx).format) {
            ...
            && ZSTD_isLegacy(src, srcSize) != 0
        {
            ...
            RETURN_ERROR_IF!(expectedSize
                == (0 as u64)
                    .wrapping_sub(2), ZSTD_error_corruption_detected);
            ...
            dst = (dst as *mut u8).offset(decodedSize as isize)
                as *mut c_void;
            dstCapacity = dstCapacity.wrapping_sub(decodedSize);
            src = (src as *const u8).offset(frameSize as isize)
                as *const c_void;
            ...
            RETURN_ERROR_IF!(ERR_getErrorCode(res) as u32
                == ZSTD_error_prefix_unknown as i32 as u32
                && moreThan1Frame == 1, ZSTD_error_srcSize_wrong);
            if ERR_isError(res) {
                return res;
            }
            if res != 0 {
                dst = (dst as *mut u8).offset(res as isize) as *mut c_void;
            }
    ...
    return (dst as *mut u8).offset_from(dststart as *mut u8) as std::ffi::c_long
        as usize;
}
#[no_mangle]
...
unsafe extern "C" fn ZSTD_nextSrcSizeToDecompressWithInputSize(
    ...
    if !((*dctx).stage as u32
        == ZSTDds_decompressBlock as i32 as u32
        || (*dctx).stage as u32
            == ZSTDds_decompressLastBlock as i32 as u32)
    {
        return (*dctx).expected;
    }
    if (*dctx).bType as u32 != bt_raw as i32 as u32
    {
        return (*dctx).expected;
    }
...
unsafe extern "C" fn ZSTD_isSkipFrame(mut dctx: *mut ZSTD_DCtx) -> i32 {
    return ((*dctx).stage as u32
        == ZSTDds_skipFrame as i32 as u32) as i32;
}
#[no_mangle]
pub unsafe extern "C" fn ZSTD_decompressContinue(
    ...
    RETURN_ERROR_IF!(srcSize != ZSTD_nextSrcSizeToDecompressWithInputSize(dctx, srcSize), ZSTD_error_srcSize_wrong);
    ZSTD_checkContinuity(dctx, dst, dstCapacity);
    (*dctx)
        .processedCSize = ((*dctx).processedCSize as std::ffi::c_ulong)
        .wrapping_add(srcSize) as u64 as u64;
    match (*dctx).stage as u32 {
        0 => {
            if (*dctx).format as u32
                == ZSTD_f_zstd1 as i32 as u32
        ...
        2 => {
            ...
            RETURN_ERROR_IF!(cBlockSize > (*dctx).fParams.blockSizeMax as usize, ZSTD_error_corruption_detected);
            ...
            if cBlockSize != 0 {
                (*dctx)
                    ...
                    ZSTDds_decompressLastBlock as i32
                } else {
                    ZSTDds_decompressBlock as i32
                }) as ZSTD_dStage;
                return 0;
            }
            if bp.lastBlock != 0 {
        ...
        4 | 3 => {
            ...
            RETURN_ERROR_IF!(rSize > (*dctx).fParams.blockSizeMax as usize, ZSTD_error_corruption_detected);
            (*dctx)
                .decodedSize = ((*dctx).decodedSize as std::ffi::c_ulong)
                .wrapping_add(rSize) as u64 as u64;
            if (*dctx).validateChecksum != 0 {
                ZSTD_XXH64_update(&mut (*dctx).xxhState, dst, rSize);
            }
            (*dctx)
                .previousDstEnd = (dst as *mut c_char).offset(rSize as isize)
                as *const c_void;
            if (*dctx).expected > 0 {
                return rSize;
            }
        ...
        5 => {
            if (*dctx).validateChecksum != 0 {
                ...
                RETURN_ERROR_IF!(check32 != h32, ZSTD_error_checksum_wrong);
            }
            ZSTD_DCtx_trace_end(
                dctx,
                (*dctx).decodedSize,
...
unsafe extern "C" fn ZSTD_refDictContent(
    ...
    (*dctx)
        .virtualStart = (dict as *const c_char)
        .offset(
    ...
    (*dctx)
        .previousDstEnd = (dict as *const c_char).offset(dictSize as isize)
        as *const c_void;
    return 0;
}
#[no_mangle]
pub unsafe extern "C" fn ZSTD_loadDEntropy(
    ...
    RETURN_ERROR_IF!(dictSize <= 8, ZSTD_error_dictionary_corrupted);
    ...
    let workspaceSize = (::core::mem::size_of::<[ZSTD_seqSymbol; 513]>()
        as std::ffi::c_ulong)
        .wrapping_add(
            ::core::mem::size_of::<[ZSTD_seqSymbol; 257]>(),
        )
        .wrapping_add(
            ::core::mem::size_of::<[ZSTD_seqSymbol; 513]>(),
        );
    ...
    RETURN_ERROR_IF!(ERR_isError(hSize), ZSTD_error_dictionary_corrupted);
    ...
    RETURN_ERROR_IF!(offcodeMaxValue > 31, ZSTD_error_dictionary_corrupted);
    ...
    RETURN_ERROR_IF!(matchlengthMaxValue > 52, ZSTD_error_dictionary_corrupted);
    ...
    RETURN_ERROR_IF!(litlengthMaxValue > 35, ZSTD_error_dictionary_corrupted);
    ...
    let mut i: i32 = 0;
    let dictContentSize = dictEnd
        .offset_from(dictPtr.offset(12)) as std::ffi::c_long
        as usize;
    i = 0;
    while i < 3 {
        let rep = MEM_readLE32(dictPtr as *const c_void);
        dictPtr = dictPtr.offset(4);
        RETURN_ERROR_IF!(rep == 0 || rep as usize > dictContentSize, ZSTD_error_dictionary_corrupted);
...
unsafe extern "C" fn ZSTD_decompress_insertDictionary(
    ...
    (*dctx)
        .dictID = MEM_readLE32(
        (dict as *const c_char).offset(ZSTD_FRAMEIDSIZE as isize)
            as *const c_void,
    );
    let eSize = ZSTD_loadDEntropy(&mut (*dctx).entropy, dict, dictSize);
    RETURN_ERROR_IF!(ERR_isError(eSize), ZSTD_error_dictionary_corrupted);
    dict = (dict as *const c_char).offset(eSize as isize)
        as *const c_void;
...
#[no_mangle]
pub unsafe extern "C" fn ZSTD_decompressBegin(mut dctx: *mut ZSTD_DCtx) -> usize {
    (*dctx)
        .traceCtx = if (Some(
...
pub unsafe extern "C" fn ZSTD_decompressBegin_usingDict(
    ...
    if !dict.is_null() && dictSize != 0 {
        RETURN_ERROR_IF!(ERR_isError(ZSTD_decompress_insertDictionary(dctx, dict, dictSize)) != 0, ZSTD_error_dictionary_corrupted);
    }
    return 0;
}
#[no_mangle]
pub unsafe extern "C" fn ZSTD_decompressBegin_usingDDict(
    ...
    if !ddict.is_null() {
        let dictStart = ZSTD_DDict_dictContent(ddict) as *const c_char;
        let dictSize = ZSTD_DDict_dictSize(ddict);
        let dictEnd = dictStart.offset(dictSize as isize) as *const c_void;
...
#[no_mangle]
pub unsafe extern "C" fn ZSTD_freeDStream(mut zds: *mut ZSTD_DStream) -> usize {
    return ZSTD_freeDCtx(zds);
}
#[no_mangle]
pub unsafe extern "C" fn ZSTD_DStreamInSize() -> usize {
    return (ZSTD_BLOCKSIZE_MAX as usize).wrapping_add(ZSTD_blockHeaderSize);
}
#[no_mangle]
...
pub unsafe extern "C" fn ZSTD_DCtx_loadDictionary_advanced(
    ...
    RETURN_ERROR_IF!((*dctx).streamStage as u32
        != zdss_init as i32 as u32, ZSTD_error_stage_wrong);
    ZSTD_clearDict(dctx);
    if !dict.is_null() && dictSize != 0 {
        (*dctx)
        ...
        RETURN_ERROR_IF!(((*dctx).ddictLocal).is_null(), ZSTD_error_memory_allocation);
    ...
    if !ddict.is_null() {
            ...
            == ZSTD_rmd_refMultipleDDicts as i32 as u32
        {
            if ((*dctx).ddictSet).is_null() {
                ...
                RETURN_ERROR_IF!(((*dctx).ddictSet).is_null(), ZSTD_error_memory_allocation);
            }
            FORWARD_IF_ERROR!(
...
pub unsafe extern "C" fn ZSTD_DCtx_setMaxWindowSize(
    ...
    RETURN_ERROR_IF!((*dctx).streamStage as u32
        != zdss_init as i32 as u32, ZSTD_error_stage_wrong);
    RETURN_ERROR_IF!(maxWindowSize < min, ZSTD_error_parameter_outOfBound);
    RETURN_ERROR_IF!(maxWindowSize > max, ZSTD_error_parameter_outOfBound);
...
pub unsafe extern "C" fn ZSTD_dParam_getBounds(
    ...
    match dParam as u32 {
        ...
        1000 => {
            bounds.lowerBound = ZSTD_f_zstd1 as i32;
            bounds.upperBound = ZSTD_f_zstd1_magicless as i32;
            return bounds;
        }
        1001 => {
            bounds.lowerBound = ZSTD_bm_buffered as i32;
            bounds.upperBound = ZSTD_bm_stable as i32;
            return bounds;
        }
        1002 => {
            bounds.lowerBound = ZSTD_d_validateChecksum as i32;
            bounds.upperBound = ZSTD_d_ignoreChecksum as i32;
            return bounds;
        }
        1003 => {
            bounds.lowerBound = ZSTD_rmd_refSingleDDict as i32;
            bounds.upperBound = ZSTD_rmd_refMultipleDDicts as i32;
            return bounds;
        }
        1004 => {
            bounds.lowerBound = 0;
...
pub unsafe extern "C" fn ZSTD_DCtx_getParameter(
    ...
    match param as u32 {
        100 => {
            *value = ZSTD_highbit32((*dctx).maxWindowSize as u32) as i32;
            return 0;
        }
        1000 => {
            *value = (*dctx).format as i32;
            return 0;
        }
        1001 => {
            *value = (*dctx).outBufferMode as i32;
            return 0;
        }
        1002 => {
            *value = (*dctx).forceIgnoreChecksum as i32;
            return 0;
        }
        1003 => {
            *value = (*dctx).refMultipleDDicts as i32;
            return 0;
        }
        1004 => {
...
pub unsafe extern "C" fn ZSTD_DCtx_setParameter(
    ...
    match dParam as u32 {
        100 => {
            ...
            RETURN_ERROR_IF!(ZSTD_dParam_withinBounds(ZSTD_d_windowLogMax, value) == 0, ZSTD_error_parameter_outOfBound);
            (*dctx).maxWindowSize = 1_usize << value;
            return 0;
        }
        1000 => {
            RETURN_ERROR_IF!(ZSTD_dParam_withinBounds(ZSTD_d_experimentalParam1, value) == 0, ZSTD_error_parameter_outOfBound);
            (*dctx).format = value as ZSTD_format_e;
            return 0;
        }
        1001 => {
            RETURN_ERROR_IF!(ZSTD_dParam_withinBounds(ZSTD_d_experimentalParam2, value) == 0, ZSTD_error_parameter_outOfBound);
            (*dctx).outBufferMode = value as ZSTD_bufferMode_e;
            return 0;
        }
        1002 => {
            RETURN_ERROR_IF!(ZSTD_dParam_withinBounds(ZSTD_d_experimentalParam3, value) == 0, ZSTD_error_parameter_outOfBound);
            (*dctx).forceIgnoreChecksum = value as ZSTD_forceIgnoreChecksum_e;
            return 0;
        }
        1003 => {
            RETURN_ERROR_IF!(ZSTD_dParam_withinBounds(ZSTD_d_experimentalParam4, value) == 0, ZSTD_error_parameter_outOfBound);
            RETURN_ERROR_IF!((*dctx).staticSize != 0, ZSTD_error_parameter_unsupported);
            (*dctx).refMultipleDDicts = value as ZSTD_refMultipleDDicts_e;
            return 0;
        }
        1004 => {
            RETURN_ERROR_IF!(ZSTD_dParam_withinBounds(ZSTD_d_experimentalParam5, value) == 0, ZSTD_error_parameter_outOfBound);
        ...
        1005 => {
            if value != 0 {
                if ZSTD_dParam_withinBounds(ZSTD_d_experimentalParam6, value) == 0 {
                    return -(ZSTD_error_parameter_outOfBound as i32)
                        as usize;
                }
            }
...
#[no_mangle]
pub unsafe extern "C" fn ZSTD_sizeof_DStream(mut dctx: *const ZSTD_DStream) -> usize {
    return ZSTD_sizeof_DCtx(dctx);
}
unsafe extern "C" fn ZSTD_decodingBufferSize_internal(
    mut windowSize: u64,
    mut frameContentSize: u64,
    ...
    let neededRBSize = windowSize
        ...
        .wrapping_add(
            (WILDCOPY_OVERLENGTH * 2 as i32) as u64,
        );
    let neededSize = std::cmp::min(frameContentSize, neededRBSize);
    let minRBSize = neededSize as usize;
    RETURN_ERROR_IF!(minRBSize as u64 != neededSize, ZSTD_error_frameParameter_windowTooLarge);
    return minRBSize;
}
#[no_mangle]
...
pub unsafe extern "C" fn ZSTD_estimateDStreamSize_fromFrame(
    ...
    RETURN_ERROR_IF!(err > 0, ZSTD_error_srcSize_wrong);
    RETURN_ERROR_IF!(zfh.windowSize > windowSizeMax as u64, ZSTD_error_frameParameter_windowTooLarge);
    return ZSTD_estimateDStreamSize(zfh.windowSize as usize);
}
unsafe extern "C" fn ZSTD_DCtx_isOverflow(
    ...
    return (((*zds).inBuffSize).wrapping_add((*zds).outBuffSize)
        >= neededInBuffSize.wrapping_add(neededOutBuffSize)
            * ZSTD_WORKSPACETOOLARGE_FACTOR as usize) as i32;
}
...
unsafe extern "C" fn ZSTD_DCtx_isOversizedTooLong(
    ...
    return ((*zds).oversizedDuration >= ZSTD_WORKSPACETOOLARGE_MAXDURATION as usize)
        as i32;
}
unsafe extern "C" fn ZSTD_checkOutBuffer(
    ...
    if (*zds).outBufferMode as u32
        != ZSTD_bm_stable as i32 as u32
    {
        return 0;
    }
    if (*zds).streamStage as u32
        == zdss_init as i32 as u32
    {
        return 0;
    }
    ...
    return ERROR(ZSTD_error_dstBuffer_wrong);
}
unsafe extern "C" fn ZSTD_decompressContinueStream(
    mut zds: *mut ZSTD_DStream,
    mut op: *mut *mut c_char,
    mut oend: *mut c_char,
    mut src: *const c_void,
    mut srcSize: usize,
) -> usize {
        ...
        == ZSTD_bm_buffered as i32 as u32
    {
        ...
        let decodedSize = ZSTD_decompressContinue(
            zds,
            ((*zds).outBuff).offset((*zds).outStart as isize) as *mut c_void,
            dstSize,
            src,
            srcSize,
        );
...
pub unsafe extern "C" fn ZSTD_decompressStream(
        ...
        match current_block_402 {
            1623252117315916725 => {
                if (*zds).legacyVersion != 0 {
                    if (*zds).staticSize != 0 {
                        return -(ZSTD_error_memory_allocation as i32)
                            as usize;
                    }
                ...
                let hSize = ZSTD_getFrameHeader_advanced(
                    &mut (*zds).fParams,
                    ((*zds).headerBuffer).as_mut_ptr() as *const c_void,
                    (*zds).lhSize,
                    (*zds).format,
                );
                if (*zds).refMultipleDDicts as u32 != 0
                ...
                if ERR_isError(hSize) {
                    let legacyVersion = ZSTD_isLegacy(
                        ...
                        iend.offset_from(istart) as std::ffi::c_long as usize,
                    );
                    if legacyVersion != 0 {
                ...
                if hSize != 0 {
                    ...
                    if (*zds).fParams.frameContentSize != ZSTD_CONTENTSIZE_UNKNOWN
                        && (*zds).fParams.frameType as u32
                            != ZSTD_skippableFrame as i32 as u32
                        && oend.offset_from(op) as std::ffi::c_long as usize
                            as u64 >= (*zds).fParams.frameContentSize
                    {
                        ...
                        _ => {
                            if (*zds).outBufferMode as u32
                                ...
                                && (oend.offset_from(op) as std::ffi::c_long as usize
                                    as u64) < (*zds).fParams.frameContentSize
                            {
                                return -(ZSTD_error_dstSize_tooSmall as i32)
                                    as usize;
                            }
                            FORWARD_IF_ERROR!(
                                ZSTD_decompressBegin_usingDDict(zds, ZSTD_getDDict(zds)), ""
                            );
                            if (*zds).format as u32
                                == ZSTD_f_zstd1 as i32 as u32
                                && MEM_readLE32(
                            ...
                            if (*zds).maxBlockSizeParam != 0 {
                                (*zds)
                                    .fParams
                                    .blockSizeMax = std::cmp::min(
                                    (*zds).fParams.blockSizeMax, (*zds).maxBlockSizeParam as u32
                                );
                            }
    ...
    (*input)
        .pos = ip.offset_from((*input).src as *const c_char)
        as std::ffi::c_long as usize;
    (*output)
        .pos = op.offset_from((*output).dst as *mut c_char) as std::ffi::c_long
        as usize;
    (*zds).expectedOutBuffer = *output;
    if ip == istart && op == ostart {
        ...
        if (*zds).noForwardProgress >= ZSTD_NO_FORWARD_PROGRESS_MAX {
            if op == oend {
                return -(ZSTD_error_noForwardProgress_destFull as i32)
                    as usize;
            }
            if ip == iend {
                return -(ZSTD_error_noForwardProgress_inputEmpty as i32)
                    as usize;
            }
        }
    } else {
    ...
    nextSrcSizeHint = nextSrcSizeHint
        .wrapping_add(
            ZSTD_blockHeaderSize
                * (ZSTD_nextInputType(zds) as u32
                    == ZSTDnit_block as i32 as u32)
                    as i32 as usize,
        );
